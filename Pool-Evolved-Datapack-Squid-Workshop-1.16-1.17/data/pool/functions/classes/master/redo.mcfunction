...
execute if data storage minecraft:swpool allowonecheat unless entity @e[tag=swPool_pooltable,tag=swPool_endgame] run function pool:classes/master/redo_run
