...
# run model
execute if score nn_complexity swPool_C matches 1 run function pool:classes/break_nn_8ball/breakmodel-1_12
# skip one layer because model is shallower
execute if score nn_complexity swPool_C matches 1 run function pool:classes/break_nn_8ball/skip_layer

execute if score nn_complexity swPool_C matches 2 run function pool:classes/break_nn_8ball/breakmodel-2_12

execute if score nn_complexity swPool_C matches 3 run function pool:classes/break_nn_8ball/breakmodel_2_16

execute if score nn_complexity swPool_C matches 4 run function pool:classes/break_nn_8ball/breakmodel-2_24
