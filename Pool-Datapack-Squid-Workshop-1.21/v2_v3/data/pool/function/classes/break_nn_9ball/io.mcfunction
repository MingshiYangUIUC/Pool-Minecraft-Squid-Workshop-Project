...
execute as @e[type=armor_stand,tag=swPool_pool,distance=0.001..,sort=nearest,limit=1] if entity @s[tag=swPool_01] run scoreboard players set @a[tag=swPool_hitcue] swPool_firsthit 1
...
execute store result score #9 swPool_posx run data get entity @e[type=armor_stand,tag=swPool_pool,tag=swPool_09,limit=1] Pos[0] 10000
execute store result score #9 swPool_posz run data get entity @e[type=armor_stand,tag=swPool_pool,tag=swPool_09,limit=1] Pos[2] 10000
...
# z direction
execute if score #Xdir swMath_V matches 0 if score #hflip swMath_V matches 1 at @e[tag=swPool_09,tag=swPool_pool,limit=1] positioned ~0.0 ~ ~1.0 run tag @e[tag=swPool_pool,tag=!swPool_cue,limit=1,type=armor_stand,sort=nearest] add swPool_tip
execute if score #Xdir swMath_V matches 0 if score #hflip swMath_V matches -1 at @e[tag=swPool_09,tag=swPool_pool,limit=1] positioned ~0.0 ~ ~-1.0 run tag @e[tag=swPool_pool,tag=!swPool_cue,limit=1,type=armor_stand,sort=nearest] add swPool_tip

# x direction
execute if score #Xdir swMath_V matches 1 if score #hflip swMath_V matches 1 at @e[tag=swPool_09,tag=swPool_pool,limit=1] positioned ~1.0 ~ ~0.0 run tag @e[tag=swPool_pool,tag=!swPool_cue,limit=1,type=armor_stand,sort=nearest] add swPool_tip
execute if score #Xdir swMath_V matches 1 if score #hflip swMath_V matches -1 at @e[tag=swPool_09,tag=swPool_pool,limit=1] positioned ~-1.0 ~ ~0.0 run tag @e[tag=swPool_pool,tag=!swPool_cue,limit=1,type=armor_stand,sort=nearest] add swPool_tip
...
# z
execute if score #Xdir swMath_V matches 0 if score #hflip swMath_V matches 1 at @e[tag=swPool_tip,limit=1] run summon armor_stand ~ ~ ~ {Tags:["swPool_rackmapper"],NoGravity:1b,Rotation:[180.0f,0.0f],Invisible:1b}
execute if score #Xdir swMath_V matches 0 if score #hflip swMath_V matches -1 at @e[tag=swPool_tip,limit=1] run summon armor_stand ~ ~ ~ {Tags:["swPool_rackmapper"],NoGravity:1b,Rotation:[-180.0f,0.0f],Invisible:1b}
...
execute as @e[tag=swPool_pool,type=armor_stand] at @s run function pool:classes/break_nn_9ball/map_xz
