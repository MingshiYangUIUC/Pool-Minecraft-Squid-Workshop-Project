...
内容创作者：**杨铭石 (YMS2001)**  [_鱿鱼MC工作室_](https://github.com/Squid-Workshop)  
联系方式：mingshi3@illinois.edu  

[CurseForge页面](https://www.curseforge.com/minecraft/data-packs/pool-and-billiards)   
[Modrinth页面](https://modrinth.com/datapack/pool-and-billiards)   
[近期更新](更新日志.md)
...
### 兼容性注意
- **通用说明：** 本数据包和资源包在多个支持的游戏版本中均可正常运行，但 `pack.mcmeta` 文件可能未及时更新。若未来 Minecraft 版本仅需修改 `pack.mcmeta` 即可兼容，可能不会专门为此发布新版本。因此，在安装时游戏可能会提示资源包或数据包“不兼容”。如需消除该提示，可参考此页面（https://minecraft.fandom.com/wiki/Pack_format），根据当前游戏版本手动修改 `pack.mcmeta` 文件。
