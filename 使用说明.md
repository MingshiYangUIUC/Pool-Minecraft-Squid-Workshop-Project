...
- **1.21:** 现已提供整合版本的数据包 `Pool-Datapack-Squid-Workshop-1.21` 和资源包 `Pool-ResourcepackFolder-Squid-Workshop-1.21`，可以在1.21的所有版本使用。`Releases_1.21` 中提供的的子版本在未来会被移除。
...
8. 我遇到了无法预期的问题。 \
请尝试重置对局、重置球桌，或卸载 / 重新加载数据包。如果问题仍然存在，请提交一个 _issue_ 或直接联系我。更推荐提交 issue，并附上问题的录屏或世界存档，帮助我发现并解决问题。
