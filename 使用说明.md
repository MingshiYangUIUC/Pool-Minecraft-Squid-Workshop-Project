...
本数据包面向所有 **Minecraft 玩家与台球爱好者**。  

支持在 **Minecraft Java Edition 1.16+** 中进行：
...
## 兼容性注意
- **1.16-1.20:** 尽管安装时游戏可能提示不兼容，数据包和资源包在多个游戏版本均可使用。如果您想移除兼容性警告，您可以自行根据这个[页面](https://minecraft.fandom.com/wiki/Pack_format)和您的游戏版本更改pack.mcmeta文件。
