...
execute if entity @a[tag=swPool_freeball] run tellraw @a[tag=swPool_spec,tag=swPool_EN] [{"text":"Freeball."}]
execute if entity @a[tag=swPool_freeball] run tellraw @a[tag=swPool_spec,tag=swPool_CN] [{"text":"自由球。"}]
