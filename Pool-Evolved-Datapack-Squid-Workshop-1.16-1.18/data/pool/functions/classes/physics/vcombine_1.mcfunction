...
#scoreboard players operation @e[type=area_effect_cloud,tag=swPool_vcomb_1,limit=1,sort=nearest] swPool_v *= C_500 swPool_C
execute as @e[type=area_effect_cloud,tag=swPool_vcomb_1,limit=1,sort=nearest] at @s run function pool:classes/motion/move_comb
execute if entity @e[type=armor_stand,tag=swPool_pooltable,tag=swPool_1st_render] run execute as @e[type=area_effect_cloud,tag=swPool_vcomb_1,limit=1,sort=nearest] at @s run particle minecraft:composter ~ ~-0.5 ~ 0 0 0 0 1 force
execute if entity @e[type=armor_stand,tag=swPool_pooltable,tag=swPool_1st_render] run tag @e[tag=swPool_pooltable,tag=swPool_1st_render,limit=1,sort=nearest] remove swPool_1st_render
