...
execute if data storage minecraft:swpool cueballreddot run item replace entity @e[tag=swPool_cue,tag=swPool_temppin] armor.head with minecraft:acacia_button[minecraft:item_model="swpool:render_cueball"]
execute unless data storage minecraft:swpool cueballreddot run item replace entity @e[tag=swPool_cue,tag=swPool_temppin] armor.head with minecraft:acacia_button[minecraft:item_model="swpool:render_cueball_clean"]
item replace entity @e[tag=swPool_red,tag=swPool_temppin] armor.head with minecraft:acacia_button[minecraft:item_model="swpool:render_red"]
item replace entity @e[tag=swPool_yellow,tag=swPool_temppin] armor.head with minecraft:acacia_button[minecraft:item_model="swpool:render_yellow"]
item replace entity @e[tag=swPool_green,tag=swPool_temppin] armor.head with minecraft:acacia_button[minecraft:item_model="swpool:render_green"]
item replace entity @e[tag=swPool_brown,tag=swPool_temppin] armor.head with minecraft:acacia_button[minecraft:item_model="swpool:render_brown"]
item replace entity @e[tag=swPool_blue,tag=swPool_temppin] armor.head with minecraft:acacia_button[minecraft:item_model="swpool:render_blue"]
item replace entity @e[tag=swPool_pink,tag=swPool_temppin] armor.head with minecraft:acacia_button[minecraft:item_model="swpool:render_pink"]
item replace entity @e[tag=swPool_black,tag=swPool_temppin] armor.head with minecraft:acacia_button[minecraft:item_model="swpool:render_black"]

item replace entity @e[tag=swPool_01,tag=swPool_temppin] armor.head with minecraft:acacia_button[minecraft:item_model="swpool:render_ball_01"]
item replace entity @e[tag=swPool_02,tag=swPool_temppin] armor.head with minecraft:acacia_button[minecraft:item_model="swpool:render_ball_02"]
item replace entity @e[tag=swPool_03,tag=swPool_temppin] armor.head with minecraft:acacia_button[minecraft:item_model="swpool:render_ball_03"]
item replace entity @e[tag=swPool_04,tag=swPool_temppin] armor.head with minecraft:acacia_button[minecraft:item_model="swpool:render_ball_04"]
item replace entity @e[tag=swPool_05,tag=swPool_temppin] armor.head with minecraft:acacia_button[minecraft:item_model="swpool:render_ball_05"]
item replace entity @e[tag=swPool_06,tag=swPool_temppin] armor.head with minecraft:acacia_button[minecraft:item_model="swpool:render_ball_06"]
item replace entity @e[tag=swPool_07,tag=swPool_temppin] armor.head with minecraft:acacia_button[minecraft:item_model="swpool:render_ball_07"]
item replace entity @e[tag=swPool_08,tag=swPool_temppin] armor.head with minecraft:acacia_button[minecraft:item_model="swpool:render_ball_08"]
item replace entity @e[tag=swPool_09,tag=swPool_temppin] armor.head with minecraft:acacia_button[minecraft:item_model="swpool:render_ball_09"]
item replace entity @e[tag=swPool_10,tag=swPool_temppin] armor.head with minecraft:acacia_button[minecraft:item_model="swpool:render_ball_10"]
item replace entity @e[tag=swPool_11,tag=swPool_temppin] armor.head with minecraft:acacia_button[minecraft:item_model="swpool:render_ball_11"]
item replace entity @e[tag=swPool_12,tag=swPool_temppin] armor.head with minecraft:acacia_button[minecraft:item_model="swpool:render_ball_12"]
item replace entity @e[tag=swPool_13,tag=swPool_temppin] armor.head with minecraft:acacia_button[minecraft:item_model="swpool:render_ball_13"]
item replace entity @e[tag=swPool_14,tag=swPool_temppin] armor.head with minecraft:acacia_button[minecraft:item_model="swpool:render_ball_14"]
item replace entity @e[tag=swPool_15,tag=swPool_temppin] armor.head with minecraft:acacia_button[minecraft:item_model="swpool:render_ball_15"]
