...
tellraw @s[tag=!swPool_mute,tag=swPool_EN] [{"text":"➇ ","color":"white"},{"text":"<Join MP Snooker> ","color":"white","underlined":true,"click_event":{"action":"run_command","command":"/trigger swPool_trigger set 119"}},{"text":"<Join SP Snooker>","color":"white","underlined":true,"click_event":{"action":"run_command","command":"/trigger swPool_trigger set 123"}}]
tellraw @s[tag=!swPool_mute,tag=swPool_EN] [{"text":"➇ ","color":"white"},{"text":"<Join MP UK8Ball> ","color":"white","underlined":true,"click_event":{"action":"run_command","command":"/trigger swPool_trigger set 121"}},{"text":"<Join SP UK8Ball>","color":"white","underlined":true,"click_event":{"action":"run_command","command":"/trigger swPool_trigger set 124"}}]
tellraw @s[tag=!swPool_mute,tag=swPool_EN] [{"text":"➇ ","color":"white"},{"text":"<Join MP CN8Ball> ","color":"white","underlined":true,"click_event":{"action":"run_command","command":"/trigger swPool_trigger set 117"}},{"text":"<Join SP CN8Ball>","color":"white","underlined":true,"click_event":{"action":"run_command","command":"/trigger swPool_trigger set 125"}}]
tellraw @s[tag=!swPool_mute,tag=swPool_EN] [{"text":"➇ ","color":"white"},{"text":"<Spectate>","color":"white","underlined":true,"click_event":{"action":"run_command","command":"/trigger swPool_trigger set 126"}},{"text":" "},{"text":"<Stop Spectating>","color":"white","underlined":true,"click_event":{"action":"run_command","command":"/trigger swPool_trigger set 127"}}]
tellraw @s[tag=!swPool_mute,tag=swPool_EN] [{"text":"➇ ","color":"white"},{"text":"<Leave Queue>","color":"dark_red","underlined":true,"click_event":{"action":"run_command","command":"/trigger swPool_trigger set 128"}}]
...
tellraw @s[tag=!swPool_mute,tag=swPool_CN] [{"text":"➇ ","color":"white"},{"text":"< 加入多人斯诺克 > ","color":"white","underlined":true,"click_event":{"action":"run_command","command":"/trigger swPool_trigger set 119"}},{"text":"< 加入单人斯诺克 >","color":"white","underlined":true,"click_event":{"action":"run_command","command":"/trigger swPool_trigger set 123"}}]
tellraw @s[tag=!swPool_mute,tag=swPool_CN] [{"text":"➇ ","color":"white"},{"text":"<加入多人英式八球> ","color":"white","underlined":true,"click_event":{"action":"run_command","command":"/trigger swPool_trigger set 121"}},{"text":"<加入单人英式八球>","color":"white","underlined":true,"click_event":{"action":"run_command","command":"/trigger swPool_trigger set 124"}}]
tellraw @s[tag=!swPool_mute,tag=swPool_CN] [{"text":"➇ ","color":"white"},{"text":"<加入多人中式八球> ","color":"white","underlined":true,"click_event":{"action":"run_command","command":"/trigger swPool_trigger set 117"}},{"text":"<加入单人中式八球>","color":"white","underlined":true,"click_event":{"action":"run_command","command":"/trigger swPool_trigger set 125"}}]
tellraw @s[tag=!swPool_mute,tag=swPool_CN] [{"text":"➇ ","color":"white"},{"text":"<观战>","color":"white","underlined":true,"click_event":{"action":"run_command","command":"/trigger swPool_trigger set 126"}},{"text":" "},{"text":"<停止观战>","color":"white","underlined":true,"click_event":{"action":"run_command","command":"/trigger swPool_trigger set 127"}}]
tellraw @s[tag=!swPool_mute,tag=swPool_CN] [{"text":"➇ ","color":"white"},{"text":"<离开队列>","color":"white","underlined":true,"click_event":{"action":"run_command","command":"/trigger swPool_trigger set 128"}}]
