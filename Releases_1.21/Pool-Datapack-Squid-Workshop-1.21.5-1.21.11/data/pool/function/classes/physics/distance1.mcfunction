...
execute store result score D2 swPool_var01 run data get entity @e[type=item_display,tag=swPool_d2,distance=..3,limit=1] Pos[0] 10000
execute store result score D2 swPool_var02 run data get entity @e[type=item_display,tag=swPool_d2,distance=..3,limit=1] Pos[2] 10000
...
execute if entity @e[type=item_display,tag=swPool_d2,distance=..3,limit=1] run scoreboard players operation @s swPool_dist = @s swPool_var00
