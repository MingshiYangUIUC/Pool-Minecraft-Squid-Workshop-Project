...
#execute if entity @e[type=item_display,tag=swPool_origin,limit=1] store result score D1 swPool_var01 run data get entity @s Pos[0] 10000
#execute if entity @e[type=item_display,tag=swPool_origin,limit=1] store result score D1 swPool_var02 run data get entity @s Pos[2] 10000
...
execute store result score D2 swPool_var01 run data get entity @e[type=item_display,tag=swPool_origin,limit=1] Pos[0] 10000
execute store result score D2 swPool_var02 run data get entity @e[type=item_display,tag=swPool_origin,limit=1] Pos[2] 10000
