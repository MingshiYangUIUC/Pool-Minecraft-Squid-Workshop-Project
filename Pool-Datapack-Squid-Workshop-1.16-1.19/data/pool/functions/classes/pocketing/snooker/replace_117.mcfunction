...
execute unless entity @e[tag=swPool_pool,tag=swPool_black] at @e[tag=swPool_pin,tag=swPool_black] run summon armor_stand ~ ~ ~ {Tags:["swPool_pool","swPool_new","swPool_black"],NoGravity:1,Small:1,Invisible:1}
execute unless entity @e[tag=swPool_pool,tag=swPool_pink] at @e[tag=swPool_pin,tag=swPool_pink] unless entity @e[tag=swPool_new] run summon armor_stand ~ ~ ~ {Tags:["swPool_pool","swPool_new","swPool_pink"],NoGravity:1,Small:1,Invisible:1}
execute unless entity @e[tag=swPool_pool,tag=swPool_blue] at @e[tag=swPool_pin,tag=swPool_blue] unless entity @e[tag=swPool_new] run summon armor_stand ~ ~ ~ {Tags:["swPool_pool","swPool_new","swPool_blue"],NoGravity:1,Small:1,Invisible:1}
execute unless entity @e[tag=swPool_pool,tag=swPool_brown] at @e[tag=swPool_pin,tag=swPool_brown] unless entity @e[tag=swPool_new] run summon armor_stand ~ ~ ~ {Tags:["swPool_pool","swPool_new","swPool_brown"],NoGravity:1,Small:1,Invisible:1}
execute unless entity @e[tag=swPool_pool,tag=swPool_green] at @e[tag=swPool_pin,tag=swPool_green] unless entity @e[tag=swPool_new] run summon armor_stand ~ ~ ~ {Tags:["swPool_pool","swPool_new","swPool_green"],NoGravity:1,Small:1,Invisible:1}
execute unless entity @e[tag=swPool_pool,tag=swPool_yellow] at @e[tag=swPool_pin,tag=swPool_yellow] unless entity @e[tag=swPool_new] run summon armor_stand ~ ~ ~ {Tags:["swPool_pool","swPool_new","swPool_yellow"],NoGravity:1,Small:1,Invisible:1}
...
#execute unless entity @e[tag=swPool_pool,tag=swPool_yellow] at @e[tag=swPool_pin,tag=swPool_yellow] unless entity @e[tag=swPool_pool,distance=..0.25] run summon armor_stand ~ ~ ~ {Tags:["swPool_pool","swPool_new","swPool_yellow"],NoGravity:1,Small:1,Invisible:1}

#cue is different
#execute unless entity @e[tag=swPool_pool,tag=swPool_cue] at @e[tag=swPool_pin,tag=swPool_cue] unless entity @e[tag=swPool_pool,distance=..0.1] run summon armor_stand ~ ~ ~ {Tags:["swPool_pool","swPool_new","swPool_cue"],NoGravity:1,Small:1,Invisible:1}
...
item replace entity @e[tag=swPool_pool,tag=swPool_new,tag=swPool_cue] armor.head with minecraft:acacia_button{CustomModelData:1}
