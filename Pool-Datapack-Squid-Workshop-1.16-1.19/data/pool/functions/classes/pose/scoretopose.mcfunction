...
execute if score pos0 swPool_pose matches 0 if score pos1 swPool_pose matches 0 if score pos2 swPool_pose matches 0 run scoreboard players add pos0 swPool_pose 1
