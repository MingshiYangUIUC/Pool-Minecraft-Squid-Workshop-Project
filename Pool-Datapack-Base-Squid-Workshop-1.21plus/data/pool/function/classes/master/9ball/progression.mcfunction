...
execute if data storage minecraft:swpool feedback_foul if entity @e[tag=swPool_hitcue,limit=1,tag=swPool_foul1] run tellraw @a[tag=swPool_hitcue,limit=1,tag=swPool_CN] [{"text":"➇ ","color":"white"},{"text":"犯规原因：未击中目标球。"}]
#execute if data storage minecraft:swpool feedback_foul if entity @e[tag=swPool_hitcue,limit=1,tag=swPool_foul1] run say f1
execute if data storage minecraft:swpool feedback_foul if entity @e[tag=swPool_hitcue,limit=1,tag=swPool_foul1] run tellraw @a[tag=swPool_hitcue,limit=1,tag=swPool_EN] [{"text":"➇ ","color":"white"},{"text":"Reason of foul: did not hit any object ball."}]
...
#execute unless score @e[tag=swPool_hitcue,limit=1] swPool_firsthit matches 1..9 run tell @e[tag=swPool_debug] Debug: the smallest ball on table is not hit

# foul: the smallest ball on table is not first hit
execute if score @e[tag=swPool_hitcue,limit=1] swPool_firsthit > #least_survival swPool_var00 run tag @e[tag=swPool_hitcue,limit=1] add swPool_foul2
execute if data storage minecraft:swpool feedback_foul if entity @e[tag=swPool_hitcue,limit=1,tag=swPool_foul2] run tellraw @a[tag=swPool_hitcue,limit=1,tag=swPool_CN] [{"text":"➇ ","color":"white"},{"text":"犯规原因：未击中正确的目标球。"}]
#execute if data storage minecraft:swpool feedback_foul if entity @e[tag=swPool_hitcue,limit=1,tag=swPool_foul2] run say f2
execute if data storage minecraft:swpool feedback_foul if entity @e[tag=swPool_hitcue,limit=1,tag=swPool_foul2] run tellraw @a[tag=swPool_hitcue,limit=1,tag=swPool_EN] [{"text":"➇ ","color":"white"},{"text":"Reason of foul: did not hit the correct object ball."}]
...
#execute if score @e[tag=swPool_hitcue,limit=1] swPool_firsthit > #least_survival swPool_var00 run tell @e[tag=swPool_debug] Debug: the smallest ball on table is not hit

#tellraw @a[tag=swPool_debug] [{"text":"Firsthit "},{"score":{"objective":"swPool_firsthit","name":"@e[tag=swPool_hitcue,limit=1]"}}]
...
execute if score Pocketed_Turn swPool_hidScore matches 0 if entity @s[tag=swPool_9ballmode,tag=!swPool_hitrail] run tag @e[tag=swPool_hitcue,limit=1] add swPool_foul3
...
#execute if data storage minecraft:swpool feedback_foul if entity @e[tag=swPool_hitcue,limit=1,tag=swPool_foul3] run say f3
...
#execute if score Pocketed_Turn swPool_hidScore matches 0 if entity @s[tag=swPool_9ballmode,tag=!swPool_hitrail] run tell @e[tag=swPool_debug] Debug: no rail or pocket
...
#execute if data storage minecraft:swpool feedback_foul if entity @e[tag=swPool_hitcue,limit=1,tag=swPool_foul4] run say f4
...
execute unless entity @e[type=item_display,tag=swPool_pool,tag=swPool_09,limit=1] if entity @e[tag=swPool_hitcue,tag=!swPool_foul] run tag @s add swPool_endgame 

execute if entity @s[tag=swPool_endgame,tag=swPool_singleplayer] if entity @e[tag=swPool_hitcue,tag=!swPool_foul] run tellraw @a[tag=swPool_spec,tag=swPool_EN] [{"text":"➇ ","color":"white"},{"selector":"@e[tag=swPool_poolplay,tag=swPool_hitcue]"},{"text":" Completes the Game. "}]
execute if entity @s[tag=swPool_endgame,tag=swPool_singleplayer] if entity @e[tag=swPool_hitcue,tag=swPool_foul] run tellraw @a[tag=swPool_spec,tag=swPool_EN] [{"text":"➇ ","color":"white"},{"selector":"@e[tag=swPool_poolplay,tag=swPool_hitcue]"},{"text":" Completes the Game. "}]
execute if entity @s[tag=swPool_endgame,tag=swPool_multiplayer] if entity @e[tag=swPool_hitcue,tag=swPool_foul] run tellraw @a[tag=swPool_spec,tag=swPool_EN] [{"text":"➇ ","color":"white"},{"selector":"@e[tag=swPool_poolplay,tag=!swPool_hitcue]"},{"text":" Wins."}]
execute if entity @s[tag=swPool_endgame,tag=swPool_multiplayer] if entity @e[tag=swPool_hitcue,tag=!swPool_foul] run tellraw @a[tag=swPool_spec,tag=swPool_EN] [{"text":"➇ ","color":"white"},{"selector":"@e[tag=swPool_poolplay,tag=swPool_hitcue]"},{"text":" Wins."}]

execute if entity @s[tag=swPool_endgame,tag=swPool_singleplayer] if entity @e[tag=swPool_hitcue,tag=!swPool_foul] run tellraw @a[tag=swPool_spec,tag=swPool_CN] [{"text":"➇ ","color":"white"},{"selector":"@e[tag=swPool_poolplay,tag=swPool_hitcue]"},{"text":"完成本局。"}]
execute if entity @s[tag=swPool_endgame,tag=swPool_singleplayer] if entity @e[tag=swPool_hitcue,tag=swPool_foul] run tellraw @a[tag=swPool_spec,tag=swPool_CN] [{"text":"➇ ","color":"white"},{"selector":"@e[tag=swPool_poolplay,tag=swPool_hitcue]"},{"text":"完成本局。"}]
execute if entity @s[tag=swPool_endgame,tag=swPool_multiplayer] if entity @e[tag=swPool_hitcue,tag=swPool_foul] run tellraw @a[tag=swPool_spec,tag=swPool_CN] [{"text":"➇ ","color":"white"},{"selector":"@e[tag=swPool_poolplay,tag=!swPool_hitcue]"},{"text":"获胜。"}]
execute if entity @s[tag=swPool_endgame,tag=swPool_multiplayer] if entity @e[tag=swPool_hitcue,tag=!swPool_foul] run tellraw @a[tag=swPool_spec,tag=swPool_CN] [{"text":"➇ ","color":"white"},{"selector":"@e[tag=swPool_poolplay,tag=swPool_hitcue]"},{"text":"获胜。"}]

# respot 9 if not end game
execute unless entity @e[type=item_display,tag=swPool_pool,tag=swPool_09,limit=1] if entity @e[tag=swPool_hitcue,tag=swPool_foul] at @s run function pool:classes/master/9ball/respot_9
...
execute if score #least_survival swPool_var00 matches 3 run tellraw @a[tag=swPool_spec,tag=swPool_CN] [{"text":"➇ ","color":"white"},{"selector":"@e[tag=swPool_poolplay,tag=swPool_nextturn]"},{"text":"请击球。"},{"text":"目标球为"},{"text":"➂","color":"red"},{"text":"号球"}]
execute if score #least_survival swPool_var00 matches 4 run tellraw @a[tag=swPool_spec,tag=swPool_CN] [{"text":"➇ ","color":"white"},{"selector":"@e[tag=swPool_poolplay,tag=swPool_nextturn]"},{"text":"请击球。"},{"text":"目标球为"},{"text":"➃","color":"light_purple"},{"text":"号球"}]
execute if score #least_survival swPool_var00 matches 5 run tellraw @a[tag=swPool_spec,tag=swPool_CN] [{"text":"➇ ","color":"white"},{"selector":"@e[tag=swPool_poolplay,tag=swPool_nextturn]"},{"text":"请击球。"},{"text":"目标球为"},{"text":"➄","color":"gold"},{"text":"号球"}]
execute if score #least_survival swPool_var00 matches 6 run tellraw @a[tag=swPool_spec,tag=swPool_CN] [{"text":"➇ ","color":"white"},{"selector":"@e[tag=swPool_poolplay,tag=swPool_nextturn]"},{"text":"请击球。"},{"text":"目标球为"},{"text":"➅","color":"green"},{"text":"号球"}]
execute if score #least_survival swPool_var00 matches 7 run tellraw @a[tag=swPool_spec,tag=swPool_CN] [{"text":"➇ ","color":"white"},{"selector":"@e[tag=swPool_poolplay,tag=swPool_nextturn]"},{"text":"请击球。"},{"text":"目标球为"},{"text":"➆","color":"dark_red"},{"text":"号球"}]
execute if score #least_survival swPool_var00 matches 8 run tellraw @a[tag=swPool_spec,tag=swPool_CN] [{"text":"➇ ","color":"white"},{"selector":"@e[tag=swPool_poolplay,tag=swPool_nextturn]"},{"text":"请击球。"},{"text":"目标球为"},{"text":"➇","color":"black"},{"text":"号球"}]
execute if score #least_survival swPool_var00 matches 9 run tellraw @a[tag=swPool_spec,tag=swPool_CN] [{"text":"➇ ","color":"white"},{"selector":"@e[tag=swPool_poolplay,tag=swPool_nextturn]"},{"text":"请击球。"},{"text":"目标球为"},{"text":"⓽","color":"yellow"},{"text":"号球"}]

# English
execute if score #least_survival swPool_var00 matches 1 run tellraw @a[tag=swPool_spec,tag=swPool_EN] [{"text":"➇ ","color":"white"},{"selector":"@e[tag=swPool_poolplay,tag=swPool_nextturn]"},{"text":" please shoot. "},{"text":"Target ball: "},{"text":"➀","color":"yellow"}]
execute if score #least_survival swPool_var00 matches 2 run tellraw @a[tag=swPool_spec,tag=swPool_EN] [{"text":"➇ ","color":"white"},{"selector":"@e[tag=swPool_poolplay,tag=swPool_nextturn]"},{"text":" please shoot. "},{"text":"Target ball: "},{"text":"➁","color":"blue"}]
execute if score #least_survival swPool_var00 matches 3 run tellraw @a[tag=swPool_spec,tag=swPool_EN] [{"text":"➇ ","color":"white"},{"selector":"@e[tag=swPool_poolplay,tag=swPool_nextturn]"},{"text":" please shoot. "},{"text":"Target ball: "},{"text":"➂","color":"red"}]
execute if score #least_survival swPool_var00 matches 4 run tellraw @a[tag=swPool_spec,tag=swPool_EN] [{"text":"➇ ","color":"white"},{"selector":"@e[tag=swPool_poolplay,tag=swPool_nextturn]"},{"text":" please shoot. "},{"text":"Target ball: "},{"text":"➃","color":"light_purple"}]
execute if score #least_survival swPool_var00 matches 5 run tellraw @a[tag=swPool_spec,tag=swPool_EN] [{"text":"➇ ","color":"white"},{"selector":"@e[tag=swPool_poolplay,tag=swPool_nextturn]"},{"text":" please shoot. "},{"text":"Target ball: "},{"text":"➄","color":"gold"}]
execute if score #least_survival swPool_var00 matches 6 run tellraw @a[tag=swPool_spec,tag=swPool_EN] [{"text":"➇ ","color":"white"},{"selector":"@e[tag=swPool_poolplay,tag=swPool_nextturn]"},{"text":" please shoot. "},{"text":"Target ball: "},{"text":"➅","color":"green"}]
execute if score #least_survival swPool_var00 matches 7 run tellraw @a[tag=swPool_spec,tag=swPool_EN] [{"text":"➇ ","color":"white"},{"selector":"@e[tag=swPool_poolplay,tag=swPool_nextturn]"},{"text":" please shoot. "},{"text":"Target ball: "},{"text":"➆","color":"dark_red"}]
execute if score #least_survival swPool_var00 matches 8 run tellraw @a[tag=swPool_spec,tag=swPool_EN] [{"text":"➇ ","color":"white"},{"selector":"@e[tag=swPool_poolplay,tag=swPool_nextturn]"},{"text":" please shoot. "},{"text":"Target ball: "},{"text":"➇","color":"black"}]
execute if score #least_survival swPool_var00 matches 9 run tellraw @a[tag=swPool_spec,tag=swPool_EN] [{"text":"➇ ","color":"white"},{"selector":"@e[tag=swPool_poolplay,tag=swPool_nextturn]"},{"text":" please shoot. "},{"text":"Target ball: "},{"text":"⓽","color":"yellow"}]

# bot command
scoreboard players set #botmove swMath_V 0
execute unless entity @s[tag=swPool_endgame] if entity @e[tag=swPool_poolplay,tag=swPool_nextturn,tag=swPool_botmode] run scoreboard players set #botmove swMath_V 1
execute if score #botmove swMath_V matches 1 run schedule function pool:classes/bot/generic/__run_ai_helper 5t
#execute if score #botmove swMath_V matches 1 run say scheduled bot move
# stop bot if endgame
...
execute if entity @s[tag=!swPool_endgame] run tellraw @a[tag=swPool_spec,tag=swPool_EN] [{"text":"➇ ","color":"white"},{"text":""},{"underlined":true,"text":"<Command Window>","color":"white","click_event":{"action":"run_command","command":"/function app:help/pool/commandwindow"}},{"text":" ","underlined":false},{"underlined":true,"text":"<undo>","color":"white","click_event":{"action":"run_command","command":"/function pool:classes/master/undo"}}]
execute unless score #botmove swMath_V matches 1 if entity @s[tag=!swPool_endgame] run tellraw @a[tag=swPool_spec,tag=swPool_EN] [{"text":"➇ ","color":"white"},{"text":"<Adjust the next strike.>","color":"white","underlined":true,"click_event":{"action":"run_command","command":"/function pool:classes/cue/map"}}]

execute if entity @s[tag=!swPool_endgame] run tellraw @a[tag=swPool_spec,tag=swPool_CN] [{"text":"➇ ","color":"white"},{"text":""},{"underlined":true,"text":"<命令窗口>","color":"white","click_event":{"action":"run_command","command":"/function app:help/pool/commandwindow"}},{"text":" ","underlined":false},{"underlined":true,"text":"<撤销上次击球>","color":"white","click_event":{"action":"run_command","command":"/function pool:classes/master/undo"}}]
execute unless score #botmove swMath_V matches 1 if entity @s[tag=!swPool_endgame] run tellraw @a[tag=swPool_spec,tag=swPool_CN] [{"text":"➇ ","color":"white"},{"text":"<调整下一次击球>","color":"white","underlined":true,"click_event":{"action":"run_command","command":"/function pool:classes/cue/map"}}]
