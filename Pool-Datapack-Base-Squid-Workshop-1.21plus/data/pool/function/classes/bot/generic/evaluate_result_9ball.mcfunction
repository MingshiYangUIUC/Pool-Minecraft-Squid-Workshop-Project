...
tag @e[type=item_display,tag=swPool_pooltable,limit=1] add swPool_singleplayer
...
execute unless entity @e[type=item_display,tag=swPool_pool,tag=swPool_09,limit=1] if entity @e[tag=swPool_shooter,tag=!swPool_foul] run tag @s add swPool_endgame 

# respot 9 if not end game
execute unless entity @e[type=item_display,tag=swPool_pool,tag=swPool_09,limit=1] if entity @e[tag=swPool_shooter,tag=swPool_foul] at @s run function pool:classes/master/9ball/respot_9
