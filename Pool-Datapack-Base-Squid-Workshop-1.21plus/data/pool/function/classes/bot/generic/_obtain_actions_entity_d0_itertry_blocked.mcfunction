...
execute if score #rank_i swMath_V < #topk swMath_V run schedule function pool:classes/bot/generic/_obtain_actions_entity_d0_itertry_blocked 4t


execute if score #rank_i swMath_V = #topk swMath_V run schedule function pool:classes/bot/generic/_demo_action_helper 4t
