...
#execute if entity @s[tag=swPool_aimstripe] run say swPool_aimstripe
#execute if entity @s[tag=swPool_aim08] run say swPool_aim08

#tellraw @a[tag=swPool_debug] [{"text":"switching? "},{"score":{"objective":"swPool_var00","name":"#switchplayer"}}]
...
execute if score swPool_9ballmode swMath_V matches 1 if entity @e[type=item_display,tag=swPool_pool,tag=swPool_09,limit=1] run scoreboard players set #least_survival swPool_var00 9
execute if score swPool_9ballmode swMath_V matches 1 if entity @e[type=item_display,tag=swPool_pool,tag=swPool_08,limit=1] run scoreboard players set #least_survival swPool_var00 8
execute if score swPool_9ballmode swMath_V matches 1 if entity @e[type=item_display,tag=swPool_pool,tag=swPool_07,limit=1] run scoreboard players set #least_survival swPool_var00 7
execute if score swPool_9ballmode swMath_V matches 1 if entity @e[type=item_display,tag=swPool_pool,tag=swPool_06,limit=1] run scoreboard players set #least_survival swPool_var00 6
execute if score swPool_9ballmode swMath_V matches 1 if entity @e[type=item_display,tag=swPool_pool,tag=swPool_05,limit=1] run scoreboard players set #least_survival swPool_var00 5
execute if score swPool_9ballmode swMath_V matches 1 if entity @e[type=item_display,tag=swPool_pool,tag=swPool_04,limit=1] run scoreboard players set #least_survival swPool_var00 4
execute if score swPool_9ballmode swMath_V matches 1 if entity @e[type=item_display,tag=swPool_pool,tag=swPool_03,limit=1] run scoreboard players set #least_survival swPool_var00 3
execute if score swPool_9ballmode swMath_V matches 1 if entity @e[type=item_display,tag=swPool_pool,tag=swPool_02,limit=1] run scoreboard players set #least_survival swPool_var00 2
execute if score swPool_9ballmode swMath_V matches 1 if entity @e[type=item_display,tag=swPool_pool,tag=swPool_01,limit=1] run scoreboard players set #least_survival swPool_var00 1
# tag the lowest-numbered ball
execute if score swPool_9ballmode swMath_V matches 1 if score #least_survival swPool_var00 matches 1 run tag @e[type=item_display,tag=swPool_pool,tag=swPool_01] add swPool_tmp_legal
execute if score swPool_9ballmode swMath_V matches 1 if score #least_survival swPool_var00 matches 2 run tag @e[type=item_display,tag=swPool_pool,tag=swPool_02] add swPool_tmp_legal
execute if score swPool_9ballmode swMath_V matches 1 if score #least_survival swPool_var00 matches 3 run tag @e[type=item_display,tag=swPool_pool,tag=swPool_03] add swPool_tmp_legal
execute if score swPool_9ballmode swMath_V matches 1 if score #least_survival swPool_var00 matches 4 run tag @e[type=item_display,tag=swPool_pool,tag=swPool_04] add swPool_tmp_legal
execute if score swPool_9ballmode swMath_V matches 1 if score #least_survival swPool_var00 matches 5 run tag @e[type=item_display,tag=swPool_pool,tag=swPool_05] add swPool_tmp_legal
execute if score swPool_9ballmode swMath_V matches 1 if score #least_survival swPool_var00 matches 6 run tag @e[type=item_display,tag=swPool_pool,tag=swPool_06] add swPool_tmp_legal
execute if score swPool_9ballmode swMath_V matches 1 if score #least_survival swPool_var00 matches 7 run tag @e[type=item_display,tag=swPool_pool,tag=swPool_07] add swPool_tmp_legal
execute if score swPool_9ballmode swMath_V matches 1 if score #least_survival swPool_var00 matches 8 run tag @e[type=item_display,tag=swPool_pool,tag=swPool_08] add swPool_tmp_legal
execute if score swPool_9ballmode swMath_V matches 1 if score #least_survival swPool_var00 matches 9 run tag @e[type=item_display,tag=swPool_pool,tag=swPool_09] add swPool_tmp_legal
...
#tellraw @a[tag=swPool_debug] [{"text":"max_S d1-s, "},{"score":{"objective":"swMath_V","name":"#maxcalcscore"}}]
...
#tellraw @a[tag=swPool_debug] [{"text":"deduct 1, "},{"score":{"objective":"swMath_V","name":"#deduct_pktblkaim"}}]
...
#tellraw @a[tag=swPool_debug] [{"text":"deduct 2, "},{"score":{"objective":"swMath_V","name":"#deduct_pktblkcue"}}]
...
#tellraw @a[tag=swPool_debug] [{"text":"max_S d1 adjust, "},{"score":{"objective":"swMath_V","name":"#maxcalcscore"}}]
