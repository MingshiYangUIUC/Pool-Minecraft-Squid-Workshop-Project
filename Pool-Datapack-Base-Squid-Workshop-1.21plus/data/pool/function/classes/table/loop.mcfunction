...
execute if score C_table_cloth_color swPool_C matches 1 unless data storage minecraft:swpool {version:[1205]} unless entity @s[scores={swPool_var01=0}] unless entity @s[scores={swPool_var02=0}] at @e[tag=swPool_placer] run summon item_frame ~ ~ ~ {Tags:["swPool_new","swPool_cloth"],Invisible:1b,Facing:1b,Fixed:1b,Item:{id:"minecraft:acacia_button",Count:1b,tag:{CustomModelData:100}}}
execute if score C_table_cloth_color swPool_C matches 2 unless data storage minecraft:swpool {version:[1205]} unless entity @s[scores={swPool_var01=0}] unless entity @s[scores={swPool_var02=0}] at @e[tag=swPool_placer] run summon item_frame ~ ~ ~ {Tags:["swPool_new","swPool_cloth"],Invisible:1b,Facing:1b,Fixed:1b,Item:{id:"minecraft:acacia_button",Count:1b,tag:{CustomModelData:110}}}
execute if score C_table_cloth_color swPool_C matches 3 unless data storage minecraft:swpool {version:[1205]} unless entity @s[scores={swPool_var01=0}] unless entity @s[scores={swPool_var02=0}] at @e[tag=swPool_placer] run summon item_frame ~ ~ ~ {Tags:["swPool_new","swPool_cloth"],Invisible:1b,Facing:1b,Fixed:1b,Item:{id:"minecraft:acacia_button",Count:1b,tag:{CustomModelData:120}}}
execute if score C_table_cloth_color swPool_C matches 4 unless data storage minecraft:swpool {version:[1205]} unless entity @s[scores={swPool_var01=0}] unless entity @s[scores={swPool_var02=0}] at @e[tag=swPool_placer] run summon item_frame ~ ~ ~ {Tags:["swPool_new","swPool_cloth"],Invisible:1b,Facing:1b,Fixed:1b,Item:{id:"minecraft:acacia_button",Count:1b,tag:{CustomModelData:130}}}
execute if score C_table_cloth_color swPool_C matches 5 unless data storage minecraft:swpool {version:[1205]} unless entity @s[scores={swPool_var01=0}] unless entity @s[scores={swPool_var02=0}] at @e[tag=swPool_placer] run summon item_frame ~ ~ ~ {Tags:["swPool_new","swPool_cloth"],Invisible:1b,Facing:1b,Fixed:1b,Item:{id:"minecraft:acacia_button",Count:1b,tag:{CustomModelData:140}}}
execute if score C_table_cloth_color swPool_C matches 6 unless data storage minecraft:swpool {version:[1205]} unless entity @s[scores={swPool_var01=0}] unless entity @s[scores={swPool_var02=0}] at @e[tag=swPool_placer] run summon item_frame ~ ~ ~ {Tags:["swPool_new","swPool_cloth"],Invisible:1b,Facing:1b,Fixed:1b,Item:{id:"minecraft:acacia_button",Count:1b,tag:{CustomModelData:150}}}

execute if data storage minecraft:swpool {version:[1205]} unless entity @s[scores={swPool_var01=0}] unless entity @s[scores={swPool_var02=0}] at @e[tag=swPool_placer] run summon item_frame ~ ~ ~ {Tags:["swPool_new","swPool_cloth"],Invisible:1b,Facing:1b,Fixed:1b,Item:{id:"minecraft:acacia_button",Count:1b}}
