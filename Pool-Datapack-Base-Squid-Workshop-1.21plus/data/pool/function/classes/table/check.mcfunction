...
tellraw @s[tag=!swPool_success,tag=swPool_EN] [{"text":"➇ ","color":"white"},{"underlined":true,"text":"<Click>","color":"red","click_event":{"action":"run_command","command":"/function pool:classes/table/start"}},{"underlined":false,"text":" to try a different setting... Table can't be too small and the size must be standard.","color":"red"}]
tellraw @s[tag=!swPool_success,tag=swPool_CN] [{"text":"➇ ","color":"white"},{"underlined":true,"text":"<点击此处>","color":"red","click_event":{"action":"run_command","command":"/function pool:classes/table/start"}},{"underlined":false,"text":"设置其它大小……桌子太小或有问题值。","color":"red"}]

execute unless entity @s[nbt={OnGround:1b}] run tellraw @s[tag=swPool_EN] [{"text":"➇ ","color":"white"},{"underlined":true,"text":"<Click>","color":"red","click_event":{"action":"run_command","command":"/function pool:classes/table/start"}},{"underlined":false,"text":" to try again... Please stand on the ground throughout.","color":"red"}]
execute unless entity @s[nbt={OnGround:1b}] run tellraw @s[tag=swPool_CN] [{"text":"➇ ","color":"white"},{"underlined":true,"text":"<点击此处>","color":"red","click_event":{"action":"run_command","command":"/function pool:classes/table/start"}},{"underlined":false,"text":"重新设置……放置时请保持站在地面。","color":"red"}]
