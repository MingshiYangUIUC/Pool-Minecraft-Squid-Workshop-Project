...
execute if entity @e[tag=swPool_pooltable,tag=swPool_cn8ball_open,tag=!swPool_cn8ball_breaking] if entity @s[tag=swPool_stripe] if score @e[tag=swPool_hitcue,limit=1] swPool_firsthit matches 2 run tag @e[tag=swPool_hitcue] add swPool_aimstripe
execute if entity @e[tag=swPool_pooltable,tag=swPool_cn8ball_open,tag=!swPool_cn8ball_breaking] if entity @s[tag=swPool_stripe] if score @e[tag=swPool_hitcue,limit=1] swPool_firsthit matches 2 run tag @e[tag=swPool_poolplay,tag=!swPool_hitcue] add swPool_aimsolid

# no longer open if target ball is determined.
execute if entity @e[tag=swPool_hitcue,tag=swPool_aimsolid] run tag 000c2be1-0001-414d-0000-000000000000 remove swPool_cn8ball_open
execute if entity @e[tag=swPool_hitcue,tag=swPool_aimstripe] run tag 000c2be1-0001-414d-0000-000000000000 remove swPool_cn8ball_open

# if potted black during break, rerack
execute if entity @e[tag=swPool_pooltable,tag=swPool_cn8ball_breaking] if score Stroke swPool_hidScore matches 0 if entity @s[tag=swPool_black] run tag 000c2be1-0001-414d-0000-000000000000 add swPool_rerack
...
execute if entity @s[tag=swPool_solid] run tag 000c2be1-0001-414d-0000-000000000000 add swPool_pktsolid
execute if entity @s[tag=swPool_stripe] run tag 000c2be1-0001-414d-0000-000000000000 add swPool_pktstripe
execute if entity @s[tag=swPool_08] run tag 000c2be1-0001-414d-0000-000000000000 add swPool_pkt08
