...
execute if entity @e[tag=swPool_pooltable,tag=!swPool_practicemode] if data storage minecraft:swpool cueballreddot if entity @e[tag=swPool_cue,tag=swPool_free] run clear @a[tag=swPool_ballinhand] carrot_on_a_stick[minecraft:item_model="swpool:object_cueball"] 1
execute if entity @e[tag=swPool_pooltable,tag=!swPool_practicemode] unless data storage minecraft:swpool cueballreddot if entity @e[tag=swPool_cue,tag=swPool_free] run clear @a[tag=swPool_ballinhand] carrot_on_a_stick[minecraft:item_model="swpool:object_cueball_clean"] 1
