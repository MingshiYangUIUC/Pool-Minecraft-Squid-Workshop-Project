...
execute unless entity @e[type=item_display,tag=swPool_pool,tag=swPool_09,limit=1] run tellraw @a[tag=swPool_spec,tag=swPool_EN] [{"text":"➇ ","color":"white"},{"text":"<Respot?>","color":"white","underlined":true,"clickEvent":{"action":"run_command","value":"/function pool:classes/master/9ball/respot_9_manual"}}]
execute unless entity @e[type=item_display,tag=swPool_pool,tag=swPool_09,limit=1] run tellraw @a[tag=swPool_spec,tag=swPool_CN] [{"text":"➇ ","color":"white"},{"text":"<复位九号球？>","color":"white","underlined":true,"clickEvent":{"action":"run_command","value":"/function pool:classes/master/9ball/respot_9_manual"}}]
