...
summon area_effect_cloud ~ ~ ~ {Tags:["swPool_placer"],Radius:0.0f,Potion:"minecraft:strong_harming",Particle:"block air",Radius:0.0f,Potion:"minecraft:strong_harming",Particle:"block air",Radius:0.0f,Potion:"minecraft:strong_harming",Particle:"block air"}
...
execute if score C_tcc swPool_C matches 1 as @e[tag=swPool_cloth,tag=!swPool_side,tag=!swPool_potl,tag=!swPool_potr,tag=!swPool_corner] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":200}}}
execute if score C_tcc swPool_C matches 1 as @e[tag=swPool_side,tag=!swPool_potl,tag=!swPool_potr,tag=!swPool_corner] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":201}}}
execute if score C_tcc swPool_C matches 1 as @e[tag=swPool_potl] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":202}}}
execute if score C_tcc swPool_C matches 1 as @e[tag=swPool_potr] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":203}}}
execute if score C_tcc swPool_C matches 1 as @e[tag=swPool_corner] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":204}}}

execute if score C_tcc swPool_C matches 2 as @e[tag=swPool_cloth,tag=!swPool_side,tag=!swPool_potl,tag=!swPool_potr,tag=!swPool_corner] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":210}}}
execute if score C_tcc swPool_C matches 2 as @e[tag=swPool_side,tag=!swPool_potl,tag=!swPool_potr,tag=!swPool_corner] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":211}}}
execute if score C_tcc swPool_C matches 2 as @e[tag=swPool_potl] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":212}}}
execute if score C_tcc swPool_C matches 2 as @e[tag=swPool_potr] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":213}}}
execute if score C_tcc swPool_C matches 2 as @e[tag=swPool_corner] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":214}}}

execute if score C_tcc swPool_C matches 3 as @e[tag=swPool_cloth,tag=!swPool_side,tag=!swPool_potl,tag=!swPool_potr,tag=!swPool_corner] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":220}}}
execute if score C_tcc swPool_C matches 3 as @e[tag=swPool_side,tag=!swPool_potl,tag=!swPool_potr,tag=!swPool_corner] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":221}}}
execute if score C_tcc swPool_C matches 3 as @e[tag=swPool_potl] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":222}}}
execute if score C_tcc swPool_C matches 3 as @e[tag=swPool_potr] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":223}}}
execute if score C_tcc swPool_C matches 3 as @e[tag=swPool_corner] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":224}}}

execute if score C_tcc swPool_C matches 4 as @e[tag=swPool_cloth,tag=!swPool_side,tag=!swPool_potl,tag=!swPool_potr,tag=!swPool_corner] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":230}}}
execute if score C_tcc swPool_C matches 4 as @e[tag=swPool_side,tag=!swPool_potl,tag=!swPool_potr,tag=!swPool_corner] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":231}}}
execute if score C_tcc swPool_C matches 4 as @e[tag=swPool_potl] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":232}}}
execute if score C_tcc swPool_C matches 4 as @e[tag=swPool_potr] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":233}}}
execute if score C_tcc swPool_C matches 4 as @e[tag=swPool_corner] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":234}}}

execute if score C_tcc swPool_C matches 5 as @e[tag=swPool_cloth,tag=!swPool_side,tag=!swPool_potl,tag=!swPool_potr,tag=!swPool_corner] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":240}}}
execute if score C_tcc swPool_C matches 5 as @e[tag=swPool_side,tag=!swPool_potl,tag=!swPool_potr,tag=!swPool_corner] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":241}}}
execute if score C_tcc swPool_C matches 5 as @e[tag=swPool_potl] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":242}}}
execute if score C_tcc swPool_C matches 5 as @e[tag=swPool_potr] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":243}}}
execute if score C_tcc swPool_C matches 5 as @e[tag=swPool_corner] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":244}}}

execute if score C_tcc swPool_C matches 6 as @e[tag=swPool_cloth,tag=!swPool_side,tag=!swPool_potl,tag=!swPool_potr,tag=!swPool_corner] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":250}}}
execute if score C_tcc swPool_C matches 6 as @e[tag=swPool_side,tag=!swPool_potl,tag=!swPool_potr,tag=!swPool_corner] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":251}}}
execute if score C_tcc swPool_C matches 6 as @e[tag=swPool_potl] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":252}}}
execute if score C_tcc swPool_C matches 6 as @e[tag=swPool_potr] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":253}}}
execute if score C_tcc swPool_C matches 6 as @e[tag=swPool_corner] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":254}}}
...
execute unless entity @e[tag=swPool_sqh] run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["swPool_helper","swPool_sqh"],Duration:99999999,Radius:0.0f,Potion:"minecraft:strong_harming",Particle:"block air",Radius:0.0f,Potion:"minecraft:strong_harming",Particle:"block air",Radius:0.0f,Potion:"minecraft:strong_harming",Particle:"block air"}
execute unless entity @e[tag=swPool_thp1] run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["swPool_helper","swPool_thp1","swPool_thp"],Duration:99999999,Radius:0.0f,Potion:"minecraft:strong_harming",Particle:"block air",Radius:0.0f,Potion:"minecraft:strong_harming",Particle:"block air",Radius:0.0f,Potion:"minecraft:strong_harming",Particle:"block air"}
execute unless entity @e[tag=swPool_thp2] run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["swPool_helper","swPool_thp2","swPool_thp"],Duration:99999999,Radius:0.0f,Potion:"minecraft:strong_harming",Particle:"block air",Radius:0.0f,Potion:"minecraft:strong_harming",Particle:"block air",Radius:0.0f,Potion:"minecraft:strong_harming",Particle:"block air"}
execute unless entity @e[tag=swPool_rhp1] run summon minecraft:area_effect_cloud ~ ~ ~ {Duration:99999999,Tags:["swPool_helper","swPool_rhp","swPool_rhp1"],Radius:0.0f,Potion:"minecraft:strong_harming",Particle:"block air",Radius:0.0f,Potion:"minecraft:strong_harming",Particle:"block air",Radius:0.0f,Potion:"minecraft:strong_harming",Particle:"block air"}
execute unless entity @e[tag=swPool_rhp2] run summon minecraft:area_effect_cloud ~ ~ ~ {Duration:99999999,Tags:["swPool_helper","swPool_rhp","swPool_rhp2"],Radius:0.0f,Potion:"minecraft:strong_harming",Particle:"block air",Radius:0.0f,Potion:"minecraft:strong_harming",Particle:"block air",Radius:0.0f,Potion:"minecraft:strong_harming",Particle:"block air"}
execute unless entity @e[tag=swPool_rhp3] run summon minecraft:area_effect_cloud ~ ~ ~ {Duration:99999999,Tags:["swPool_helper","swPool_rhp","swPool_rhp3"],Radius:0.0f,Potion:"minecraft:strong_harming",Particle:"block air",Radius:0.0f,Potion:"minecraft:strong_harming",Particle:"block air",Radius:0.0f,Potion:"minecraft:strong_harming",Particle:"block air"}
execute unless entity @e[tag=swPool_vcomb] run summon minecraft:area_effect_cloud ~ ~ ~ {Duration:99999999,Tags:["swPool_helper","swPool_rhp","swPool_vcomb"],Radius:0.0f,Potion:"minecraft:strong_harming",Particle:"block air",Radius:0.0f,Potion:"minecraft:strong_harming",Particle:"block air",Radius:0.0f,Potion:"minecraft:strong_harming",Particle:"block air"}
