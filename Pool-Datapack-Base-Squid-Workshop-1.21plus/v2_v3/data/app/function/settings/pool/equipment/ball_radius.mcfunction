...
execute if data storage minecraft:swpool {version:[1210]} run tellraw @s[tag=swPool_EN] [{"text":"➇ ","color":"white"},{"text":"Default: 1250。","color":"gray"},{"text":"Current: "},{"score":{"objective":"swPool_C","name":"C_r"}},{"text":". "},{"underlined":true,"text":"<Click and type>","color":"white","clickEvent":{"action":"suggest_command","value":"/scoreboard players set C_r swPool_C "}}]
...
execute if data storage minecraft:swpool {version:[1210]} run tellraw @s[tag=swPool_CN] [{"text":"➇ ","color":"white"},{"text":"默认：1250。","color":"gray"},{"text":"当前值: "},{"score":{"objective":"swPool_C","name":"C_r"}},{"text":". "},{"underlined":true,"text":"<点此处后输入>","color":"white","clickEvent":{"action":"suggest_command","value":"/scoreboard players set C_r swPool_C "}}]
