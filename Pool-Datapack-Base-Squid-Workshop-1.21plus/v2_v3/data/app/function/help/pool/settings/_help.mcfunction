...
tellraw @s[tag=swPool_EN] [{"text":"➇ ", "color":"gold"},{"underlined":true,"text":"<bot/action_space_5>","clickEvent":{"action":"run_command","value":"/function app:settings/pool/bot/action_space_5"}},{"underlined":false, "color":"white","text":"    Bot evaluates 5 force-spin combinations per aim point."}]
tellraw @s[tag=swPool_CN] [{"text":"➇ ", "color":"gold"},{"underlined":true,"text":"<bot/action_space_5>","clickEvent":{"action":"run_command","value":"/function app:settings/pool/bot/action_space_5"}},{"underlined":false, "color":"white","text":"    电脑玩家基于每个瞄准点评估 5 种力度和旋转的组合。"}]

tellraw @s[tag=swPool_EN] [{"text":"➇ ", "color":"gold"},{"underlined":true,"text":"<bot/action_space_10>","clickEvent":{"action":"run_command","value":"/function app:settings/pool/bot/action_space_10"}},{"underlined":false, "color":"white","text":"    Bot evaluates 10 force-spin combinations per aim point. Increase tick_per_eval if needed."}]
tellraw @s[tag=swPool_CN] [{"text":"➇ ", "color":"gold"},{"underlined":true,"text":"<bot/action_space_10>","clickEvent":{"action":"run_command","value":"/function app:settings/pool/bot/action_space_10"}},{"underlined":false, "color":"white","text":"    电脑玩家基于每个瞄准点评估 10 种力度和旋转的组合。"}]
...
tellraw @s[tag=swPool_EN] [{"text":"➇ ", "color":"gold"},{"underlined":true,"text":"<equipment/ball_radius>","clickEvent":{"action":"run_command","value":"/function app:settings/pool/equipment/ball_radius"}},{"underlined":false, "color":"white","text":"    Only available for 1.21 and later versions. Change the radius of pool ball (1000=10cm), pockets will be scaled accordingly during new table placement."}]
tellraw @s[tag=swPool_CN] [{"text":"➇ ", "color":"gold"},{"underlined":true,"text":"<equipment/ball_radius>","clickEvent":{"action":"run_command","value":"/function app:settings/pool/equipment/ball_radius"}},{"underlined":false, "color":"white","text":"    仅适用于1.21及之后版本。更改台球的半径(1000=10cm)，下次放置球桌时袋口会相应缩放。"}]
...
tellraw @s[tag=swPool_EN] [{"text":"➇ ", "color":"gold"},{"underlined":true,"text":"<equipment/enforce_1x2>","clickEvent":{"action":"run_command","value":"/function app:settings/pool/equipment/enforce_1x2"}},{"underlined":false, "color":"white","text":"    Only available for 1.21 and later versions. If the table is placed with length equal to 2× width, the playable area will be adjusted to an exact 1:2 ratio."}]
tellraw @s[tag=swPool_CN] [{"text":"➇ ", "color":"gold"},{"underlined":true,"text":"<equipment/enforce_1x2>","clickEvent":{"action":"run_command","value":"/function app:settings/pool/equipment/enforce_1x2"}},{"underlined":false, "color":"white","text":"    仅适用于1.21及之后版本。如果放置球桌时长度设为宽度的 2 倍，球桌可用区域会被调整为精确的 1:2 比例。"}]

tellraw @s[tag=swPool_EN] [{"text":"➇ ", "color":"gold"},{"underlined":true,"text":"<equipment/neglect_1x2>","clickEvent":{"action":"run_command","value":"/function app:settings/pool/equipment/neglect_1x2"}},{"underlined":false, "color":"white","text":"    Only available for 1.21 and later versions. If the table is placed with length equal to 2× width, the playable area will **not** be adjusted to an exact 1:2 ratio."}]
tellraw @s[tag=swPool_CN] [{"text":"➇ ", "color":"gold"},{"underlined":true,"text":"<equipment/neglect_1x2>","clickEvent":{"action":"run_command","value":"/function app:settings/pool/equipment/neglect_1x2"}},{"underlined":false, "color":"white","text":"    仅适用于1.21及之后版本。如果放置球桌时长度设为宽度的 2 倍，球桌可用区域**不会**被强制调整为精确的 1:2 比例。"}]
...
tellraw @s[tag=swPool_EN] [{"text":"➇ ", "color":"gold"},{"underlined":true,"text":"<need_recipes/recipe_off>","clickEvent":{"action":"run_command","value":"/function app:settings/pool/need_recipes/recipe_off"}},{"underlined":false, "color":"white","text":"    Disable crafting recipe requirements in non-Creative mode (Minecraft 1.20.5+). Cue sticks and pool tables can be obtained directly through the command window."}]
tellraw @s[tag=swPool_CN] [{"text":"➇ ", "color":"gold"},{"underlined":true,"text":"<need_recipes/recipe_off>","clickEvent":{"action":"run_command","value":"/function app:settings/pool/need_recipes/recipe_off"}},{"underlined":false, "color":"white","text":"    关闭非创造模式下的配方要求（适用于 Minecraft 1.20.5+）。球杆和球桌可直接通过命令窗口获取。"}]

tellraw @s[tag=swPool_EN] [{"text":"➇ ", "color":"gold"},{"underlined":true,"text":"<need_recipes/recipe_on>","clickEvent":{"action":"run_command","value":"/function app:settings/pool/need_recipes/recipe_on"}},{"underlined":false, "color":"white","text":"    Enable crafting recipe requirements in non-Creative mode (Minecraft 1.20.5+). Cue sticks and pool tables must be obtained through crafting."}]
tellraw @s[tag=swPool_CN] [{"text":"➇ ", "color":"gold"},{"underlined":true,"text":"<need_recipes/recipe_on>","clickEvent":{"action":"run_command","value":"/function app:settings/pool/need_recipes/recipe_on"}},{"underlined":false, "color":"white","text":"    开启非创造模式下的配方要求（适用于 Minecraft 1.20.5+）。球杆和球桌需要通过合成获得。"}]
...
tellraw @s[tag=swPool_EN] [{"text":"➇ ", "color":"gold"},{"underlined":true,"text":"<restitution/impact>","clickEvent":{"action":"run_command","value":"/function app:settings/pool/restitution/impact"}},{"underlined":false, "color":"white","text":"    Impact (cushion) restitution coef, physically 0-10000 corresponds to 0.0000-1.0000 in simulation"}]
tellraw @s[tag=swPool_CN] [{"text":"➇ ", "color":"gold"},{"underlined":true,"text":"<restitution/impact>","clickEvent":{"action":"run_command","value":"/function app:settings/pool/restitution/impact"}},{"underlined":false, "color":"white","text":"    撞击（库边）的恢复系数，数值0-10000等效于0.0000-1.0000"}]
