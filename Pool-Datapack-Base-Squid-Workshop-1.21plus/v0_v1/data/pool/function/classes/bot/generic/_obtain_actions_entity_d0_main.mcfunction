...
execute if score #maxcalcscore swMath_V matches -1 at @e[tag=swPool_tmp_legal,limit=1,sort=random] run summon minecraft:area_effect_cloud ~ ~ ~ {Tags:["swPool_helper","swPool_aim_obj","swPool_aim_obj_rand"],Duration:1200}
