execute if entity @s[nbt={OnGround:1b,SelectedItem:{id:"minecraft:bow",components:{"minecraft:item_model":"swpool:cuestick"}}}] at @s run summon area_effect_cloud ^ ^ ^ {Tags:["swPool_aim"],Radius:0.0f,Potion:"minecraft:strong_harming",Particle:"block air"}
