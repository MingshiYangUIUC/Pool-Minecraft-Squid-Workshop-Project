...
execute if score #tick swPool_var00 matches 0 if entity @e[type=item_display,tag=swPool_pool,scores={swPool_v=1..}] at @e[type=item_display,tag=swPool_pooltable] run function pool:classes/main/tick_iterate
