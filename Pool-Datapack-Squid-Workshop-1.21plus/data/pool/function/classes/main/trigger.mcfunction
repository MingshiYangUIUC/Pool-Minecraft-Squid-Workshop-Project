...
execute if score @s swPool__trigger matches 1133041 run function app:settings/pool/equipment/ball_radius
execute if score @s swPool__trigger matches 1133042 run function app:settings/pool/equipment/cloth_color
execute if score @s swPool__trigger matches 1133043 run function app:settings/pool/equipment/enforce_1x2
execute if score @s swPool__trigger matches 1133044 run function app:settings/pool/equipment/neglect_1x2
execute if score @s swPool__trigger matches 1133045 run function app:settings/pool/equipment/stick_type
execute if score @s swPool__trigger matches 1133046 run function app:settings/pool/equipment/table_rim_type
