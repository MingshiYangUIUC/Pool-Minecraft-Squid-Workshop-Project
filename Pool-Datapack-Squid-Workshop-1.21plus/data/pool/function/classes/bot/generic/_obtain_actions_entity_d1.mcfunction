...
# if not switch
execute if entity @e[tag=swPool_pooltable,tag=swPool_cn8ballmode] if score #switchplayer swPool_var00 matches 0 if entity @s[tag=swPool_aimsolid] run tag @e[tag=swPool_pool,tag=swPool_solid] add swPool_tmp_legal
execute if entity @e[tag=swPool_pooltable,tag=swPool_cn8ballmode] if score #switchplayer swPool_var00 matches 0 if entity @s[tag=swPool_aimstripe] run tag @e[tag=swPool_pool,tag=swPool_stripe] add swPool_tmp_legal
execute if entity @e[tag=swPool_pooltable,tag=swPool_cn8ballmode] if score #switchplayer swPool_var00 matches 0 if entity @s[tag=swPool_aim08] run tag @e[tag=swPool_pool,tag=swPool_08] add swPool_tmp_legal
# change if switch player
execute if entity @e[tag=swPool_pooltable,tag=swPool_cn8ballmode] if score #switchplayer swPool_var00 matches 1 if entity @s[tag=swPool_aimsolid] if entity @e[tag=swPool_pool,tag=swPool_stripe] run tag @e[tag=swPool_pool,tag=swPool_stripe] add swPool_tmp_legal
execute if entity @e[tag=swPool_pooltable,tag=swPool_cn8ballmode] if score #switchplayer swPool_var00 matches 1 if entity @s[tag=swPool_aimsolid] unless entity @e[tag=swPool_pool,tag=swPool_stripe] run tag @e[tag=swPool_pool,tag=swPool_08] add swPool_tmp_legal
execute if entity @e[tag=swPool_pooltable,tag=swPool_cn8ballmode] if score #switchplayer swPool_var00 matches 1 if entity @s[tag=swPool_aimstripe] if entity @e[tag=swPool_pool,tag=swPool_solid] run tag @e[tag=swPool_pool,tag=swPool_solid] add swPool_tmp_legal
execute if entity @e[tag=swPool_pooltable,tag=swPool_cn8ballmode] if score #switchplayer swPool_var00 matches 1 if entity @s[tag=swPool_aimstripe] unless entity @e[tag=swPool_pool,tag=swPool_solid] run tag @e[tag=swPool_pool,tag=swPool_08] add swPool_tmp_legal
execute if entity @e[tag=swPool_pooltable,tag=swPool_cn8ballmode] if score #switchplayer swPool_var00 matches 1 if entity @s[tag=swPool_aim08] if entity @e[tag=swPool_pool,tag=swPool_solid] run tag @e[tag=swPool_pool,tag=swPool_solid] add swPool_tmp_legal
execute if entity @e[tag=swPool_pooltable,tag=swPool_cn8ballmode] if score #switchplayer swPool_var00 matches 1 if entity @s[tag=swPool_aim08] if entity @e[tag=swPool_pool,tag=swPool_stripe] run tag @e[tag=swPool_pool,tag=swPool_stripe] add swPool_tmp_legal
execute if entity @e[tag=swPool_pooltable,tag=swPool_cn8ballmode] if score #switchplayer swPool_var00 matches 1 if entity @s[tag=swPool_aim08] unless entity @e[tag=swPool_pool,tag=swPool_solid] unless entity @e[tag=swPool_pool,tag=swPool_stripe] run tag @e[tag=swPool_pool,tag=swPool_08] add swPool_tmp_legal
