...
execute at @s[scores={swPool_v=1..49999999}] run tag @e[type=item_display,tag=swPool_fake,distance=0.001..1.75,sort=nearest,limit=6] add swPool_near
execute at @s[scores={swPool_v=50000000..}] run tag @e[type=item_display,tag=swPool_fake,distance=0.001..2.25,sort=nearest,limit=6] add swPool_near
