...
execute unless entity @e[type=item_display,tag=swPool_pool,tag=swPool_09,limit=1] unless entity @e[type=item_display,tag=swPool_pool,tag=swPool_cue,limit=1] run tellraw @a[tag=swPool_spec,tag=swPool_EN] [{"text":"➇ ","color":"white"},{"text":"<Respot?>","color":"white","underlined":true,"click_event":{"action":"run_command","command":"/trigger swPool_trigger set 204"}}]
execute unless entity @e[type=item_display,tag=swPool_pool,tag=swPool_09,limit=1] unless entity @e[type=item_display,tag=swPool_pool,tag=swPool_cue,limit=1] run tellraw @a[tag=swPool_spec,tag=swPool_CN] [{"text":"➇ ","color":"white"},{"text":"<复位九号球？>","color":"white","underlined":true,"click_event":{"action":"run_command","command":"/trigger swPool_trigger set 204"}}]

tellraw @a[tag=swPool_spec,tag=swPool_EN] [{"text":"➇ ","color":"white"},{"text":""},{"underlined":true,"text":"<Command Window>","color":"white","click_event":{"action":"run_command","command":"/trigger swPool_trigger set 22"}},{"text":" ","underlined":false},{"underlined":true,"text":"<undo>","color":"white","click_event":{"action":"run_command","command":"/trigger swPool_trigger set 203"}},{"text":" ","underlined":false},{"underlined":true,"text":"<Ball in Hand>","color":"white","click_event":{"action":"run_command","command":"/trigger swPool_trigger set 205"}}]
