...
execute if entity @e[tag=swPool_pooltable,type=item_display,tag=!swPool_practicemode] as @a[tag=swPool_ballinhand] run function app:get/pool/cueball_helper
