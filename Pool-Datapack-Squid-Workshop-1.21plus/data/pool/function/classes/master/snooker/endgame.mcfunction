...
tellraw @a[tag=swPool_spec,tag=swPool_EN] [{"text":"➇ ","color":"white"},{"underlined":true,"text":"<Kill current game>","color":"yellow","click_event":{"action":"run_command","command":"/trigger swPool__trigger set 4111020"}},{"text":""},{"underlined":true,"text":"<Command Window>","color":"white","click_event":{"action":"run_command","command":"/trigger swPool__trigger set 1"}}]

tellraw @a[tag=swPool_spec,tag=swPool_CN] [{"text":"➇ ","color":"white"},{"underlined":true,"text":"<结束当前游戏>","color":"yellow","click_event":{"action":"run_command","command":"/trigger swPool__trigger set 4111020"}},{"text":""},{"underlined":true,"text":"<命令窗口>","color":"white","click_event":{"action":"run_command","command":"/trigger swPool__trigger set 1"}}]
