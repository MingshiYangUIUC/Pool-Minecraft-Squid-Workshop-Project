...
#end_output
#tellraw @s[tag=swPool_EN] [{"text":"➇ ","color":"white"},{"underlined":true,"text":"<Practice>","color":"gold","click_event":{"action":"run_command","command":"/trigger swPool_trigger set 217"}}]
#tellraw @s[tag=swPool_EN] [{"text":"➇ ","color":"white"},{"underlined":true,"text":"<DUO Snooker>","color":"gold","click_event":{"action":"run_command","command":"/trigger swPool_trigger set 216"}},{"text":" ","underlined":false},{"underlined":true,"text":"<SP Snooker>","color":"yellow","click_event":{"action":"run_command","command":"/trigger swPool_trigger set 218"}},{"text":" ","underlined":false},{"underlined":true,"text":"<DUO UK 8 Ball>","color":"gold","click_event":{"action":"run_command","command":"/trigger swPool_trigger set 219"}},{"text":" ","underlined":false},{"underlined":true,"text":"<SP UK 8 Ball>","color":"yellow","click_event":{"action":"run_command","command":"/trigger swPool_trigger set 220"}}]

#tellraw @s[tag=swPool_CN] [{"text":"➇ ","color":"white"},{"underlined":true,"text":"<练习模式>","color":"gold","click_event":{"action":"run_command","command":"/trigger swPool_trigger set 217"}}]
#tellraw @s[tag=swPool_CN] [{"text":"➇ ","color":"white"},{"underlined":true,"text":"<双人斯诺克>","color":"gold","click_event":{"action":"run_command","command":"/trigger swPool_trigger set 216"}},{"text":" ","underlined":false},{"underlined":true,"text":"<单人斯诺克>","color":"yellow","click_event":{"action":"run_command","command":"/trigger swPool_trigger set 218"}},{"text":" ","underlined":false},{"underlined":true,"text":"<双人英式八球>","color":"gold","click_event":{"action":"run_command","command":"/trigger swPool_trigger set 219"}},{"text":" ","underlined":false},{"underlined":true,"text":"<单人英式八球>","color":"yellow","click_event":{"action":"run_command","command":"/trigger swPool_trigger set 220"}}]
