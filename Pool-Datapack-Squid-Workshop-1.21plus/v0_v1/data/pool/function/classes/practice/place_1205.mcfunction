...
execute as @e[tag=swPool_01,tag=!swPool_placed] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":21}}}
execute as @e[tag=swPool_02,tag=!swPool_placed] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":22}}}
execute as @e[tag=swPool_03,tag=!swPool_placed] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":23}}}
execute as @e[tag=swPool_04,tag=!swPool_placed] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":24}}}
execute as @e[tag=swPool_05,tag=!swPool_placed] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":25}}}
execute as @e[tag=swPool_06,tag=!swPool_placed] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":26}}}
execute as @e[tag=swPool_07,tag=!swPool_placed] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":27}}}
execute as @e[tag=swPool_08,tag=!swPool_placed] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":28}}}
execute as @e[tag=swPool_09,tag=!swPool_placed] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":29}}}
execute as @e[tag=swPool_10,tag=!swPool_placed] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":30}}}
execute as @e[tag=swPool_11,tag=!swPool_placed] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":31}}}
execute as @e[tag=swPool_12,tag=!swPool_placed] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":32}}}
execute as @e[tag=swPool_13,tag=!swPool_placed] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":33}}}
execute as @e[tag=swPool_14,tag=!swPool_placed] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":34}}}
execute as @e[tag=swPool_15,tag=!swPool_placed] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":35}}}
...
tellraw @a[tag=swPool_spec,tag=swPool_EN] [{"text":"➇ ","color":"white"},{"text":""},{"underlined":true,"text":"<Command Window>","color":"white","clickEvent":{"action":"run_command","value":"/trigger swPool__trigger set 1"}},{"text":" ","underlined":false},{"underlined":true,"text":"<Replace the last ball>","color":"white","clickEvent":{"action":"run_command","value":"/trigger swPool__trigger set 14111215"}}]
tellraw @a[tag=swPool_spec,tag=swPool_CN] [{"text":"➇ ","color":"white"},{"text":""},{"underlined":true,"text":"<命令窗口>","color":"white","clickEvent":{"action":"run_command","value":"/trigger swPool__trigger set 1"}},{"text":" ","underlined":false},{"underlined":true,"text":"<撤销本次摆球>","color":"white","clickEvent":{"action":"run_command","value":"/trigger swPool__trigger set 14111215"}}]

execute if entity @e[tag=swPool_free,tag=swPool_cue] run tellraw @a[tag=swPool_spec,tag=swPool_EN] [{"text":"➇ ","color":"white"},{"text":"<Adjust the next strike.>","color":"white","underlined":true,"clickEvent":{"action":"run_command","value":"/trigger swPool__trigger set 14110806"}}]
execute if entity @e[tag=swPool_free,tag=swPool_cue] run tellraw @a[tag=swPool_spec,tag=swPool_CN] [{"text":"➇ ","color":"white"},{"text":"<调整下一次击球>","color":"white","underlined":true,"clickEvent":{"action":"run_command","value":"/trigger swPool__trigger set 14110806"}}]
