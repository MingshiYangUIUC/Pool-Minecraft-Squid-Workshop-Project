...
execute unless score #muteall swPool_C matches 1 run execute if data storage minecraft:swpool cueballreddot run execute as @e[tag=swPool_cue,tag=swPool_temppin] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":1}}}
execute unless score #muteall swPool_C matches 1 run execute unless data storage minecraft:swpool cueballreddot run execute as @e[tag=swPool_cue,tag=swPool_temppin] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":36}}}
execute unless score #muteall swPool_C matches 1 run execute as @e[tag=swPool_red,tag=swPool_temppin] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":2}}}
execute unless score #muteall swPool_C matches 1 run execute as @e[tag=swPool_yellow,tag=swPool_temppin] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":3}}}
execute unless score #muteall swPool_C matches 1 run execute as @e[tag=swPool_green,tag=swPool_temppin] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":4}}}
execute unless score #muteall swPool_C matches 1 run execute as @e[tag=swPool_brown,tag=swPool_temppin] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":5}}}
execute unless score #muteall swPool_C matches 1 run execute as @e[tag=swPool_blue,tag=swPool_temppin] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":6}}}
execute unless score #muteall swPool_C matches 1 run execute as @e[tag=swPool_pink,tag=swPool_temppin] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":7}}}
execute unless score #muteall swPool_C matches 1 run execute as @e[tag=swPool_black,tag=swPool_temppin] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":8}}}

execute unless score #muteall swPool_C matches 1 run execute as @e[tag=swPool_01,tag=swPool_temppin] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":21}}}
execute unless score #muteall swPool_C matches 1 run execute as @e[tag=swPool_02,tag=swPool_temppin] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":22}}}
execute unless score #muteall swPool_C matches 1 run execute as @e[tag=swPool_03,tag=swPool_temppin] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":23}}}
execute unless score #muteall swPool_C matches 1 run execute as @e[tag=swPool_04,tag=swPool_temppin] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":24}}}
execute unless score #muteall swPool_C matches 1 run execute as @e[tag=swPool_05,tag=swPool_temppin] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":25}}}
execute unless score #muteall swPool_C matches 1 run execute as @e[tag=swPool_06,tag=swPool_temppin] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":26}}}
execute unless score #muteall swPool_C matches 1 run execute as @e[tag=swPool_07,tag=swPool_temppin] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":27}}}
execute unless score #muteall swPool_C matches 1 run execute as @e[tag=swPool_08,tag=swPool_temppin] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":28}}}
execute unless score #muteall swPool_C matches 1 run execute as @e[tag=swPool_09,tag=swPool_temppin] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":29}}}
execute unless score #muteall swPool_C matches 1 run execute as @e[tag=swPool_10,tag=swPool_temppin] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":30}}}
execute unless score #muteall swPool_C matches 1 run execute as @e[tag=swPool_11,tag=swPool_temppin] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":31}}}
execute unless score #muteall swPool_C matches 1 run execute as @e[tag=swPool_12,tag=swPool_temppin] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":32}}}
execute unless score #muteall swPool_C matches 1 run execute as @e[tag=swPool_13,tag=swPool_temppin] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":33}}}
execute unless score #muteall swPool_C matches 1 run execute as @e[tag=swPool_14,tag=swPool_temppin] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":34}}}
execute unless score #muteall swPool_C matches 1 run execute as @e[tag=swPool_15,tag=swPool_temppin] run data merge entity @s {item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":35}}}
