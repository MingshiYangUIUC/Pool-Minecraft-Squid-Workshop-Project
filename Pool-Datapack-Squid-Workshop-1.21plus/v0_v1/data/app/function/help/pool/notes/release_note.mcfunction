...
tellraw @s [{"text":"➇ ⭐ ","color":"aqua"},{"text":"<GitHub>","underlined":true,"clickEvent":{"action":"open_url","value":"https://github.com/MingshiYangUIUC/Pool-Minecraft-Squid-Workshop-Project"}}]
tellraw @s [{"text":"➇ ❤ ","color":"green"},{"text":"<Modrinth>","underlined":true,"clickEvent":{"action":"open_url","value":"https://modrinth.com/datapack/pool-and-billiards"}}]
tellraw @s [{"text":"➇ ❤ ","color":"gold"},{"text":"<CurseForge>","underlined":true,"clickEvent":{"action":"open_url","value":"https://www.curseforge.com/minecraft/data-packs/pool-and-billiards"}}]
