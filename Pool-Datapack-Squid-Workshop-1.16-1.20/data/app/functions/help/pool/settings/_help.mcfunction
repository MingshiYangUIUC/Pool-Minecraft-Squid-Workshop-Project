...
tellraw @s[tag=swPool_EN] [{"text":"➇ ", "color":"gold"},{"underlined":true,"text":"<breakshot/breakpower>","clickEvent":{"action":"run_command","value":"/function app:settings/pool/breakshot/breakpower"}},{"underlined":false, "color":"white","text":"    (8/9 ball) increase speed of breakshot (120 means 120% speed)"}]
tellraw @s[tag=swPool_CN] [{"text":"➇ ", "color":"gold"},{"underlined":true,"text":"<breakshot/breakpower>","clickEvent":{"action":"run_command","value":"/function app:settings/pool/breakshot/breakpower"}},{"underlined":false, "color":"white","text":"    （八/九球）开球速度提升（120为120%速度）"}]
