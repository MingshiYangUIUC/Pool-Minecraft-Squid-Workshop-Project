...
scoreboard players operation #vIn2 swMath_V = @e[type=armor_stand,tag=swPool_a2,limit=1] swPool_vx
scoreboard players operation #vIn swMath_V = @s swPool_vz
scoreboard players operation #vIn2 swMath_V -= @s swPool_vx
scoreboard players operation #vIn swMath_V -= @e[type=armor_stand,tag=swPool_a2,limit=1] swPool_vz
