...
execute if data storage minecraft:swpool {version:[1205]} as @e[tag=swPool_cloth,tag=!swPool_side,tag=!swPool_potl,tag=!swPool_potr,tag=!swPool_corner] run data merge entity @s {Item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":9}}}
execute if data storage minecraft:swpool {version:[1205]} as @e[tag=swPool_side,tag=!swPool_potl,tag=!swPool_potr,tag=!swPool_corner] run data merge entity @s {Item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":10}}}
execute if data storage minecraft:swpool {version:[1205]} as @e[tag=swPool_potl] run data merge entity @s {Item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":11}}}
execute if data storage minecraft:swpool {version:[1205]} as @e[tag=swPool_potr] run data merge entity @s {Item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":12}}}
execute if data storage minecraft:swpool {version:[1205]} as @e[tag=swPool_corner] run data merge entity @s {Item:{id:"minecraft:acacia_button",Count:1b,components:{"minecraft:custom_model_data":13}}}
