...
execute if score #9ball_init swMath_V matches 1 run tag 000c2be1-0001-414d-0000-000000000000 add swPool_9ball_aibreak
execute if score #9ball_init swMath_V matches 1 run scoreboard players set swPool_9ball_aibreak swMath_V 1
...
execute if score #9ball_init swMath_V matches 1 run schedule function pool:classes/9ball/startsp_helper_botmode_finalize 10t
