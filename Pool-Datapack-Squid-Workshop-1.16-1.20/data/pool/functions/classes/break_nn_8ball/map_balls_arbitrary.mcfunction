...
execute positioned ^-1 ^ ^-100 run scoreboard players operation @e[limit=1,sort=nearest,tag=!swPool_fake,tag=swPool_pool,tag=!swPool_cue,tag=!swPool_rack_assigned,type=armor_stand] swPool_vx = #10voH swMath_V
execute positioned ^-1 ^ ^-100 run scoreboard players operation @e[limit=1,sort=nearest,tag=!swPool_fake,tag=swPool_pool,tag=!swPool_cue,tag=!swPool_rack_assigned,type=armor_stand] swPool_vz = #10voV swMath_V
execute positioned ^-1 ^ ^-100 run tag @e[limit=1,sort=nearest,tag=!swPool_fake,tag=swPool_pool,tag=!swPool_cue,tag=!swPool_rack_assigned,type=armor_stand] add swPool_rack_assigned

execute positioned ^-1 ^ ^-100 run scoreboard players operation @e[limit=1,sort=nearest,tag=!swPool_fake,tag=swPool_pool,tag=!swPool_cue,tag=!swPool_rack_assigned,type=armor_stand] swPool_vx = #11voH swMath_V
execute positioned ^-1 ^ ^-100 run scoreboard players operation @e[limit=1,sort=nearest,tag=!swPool_fake,tag=swPool_pool,tag=!swPool_cue,tag=!swPool_rack_assigned,type=armor_stand] swPool_vz = #11voV swMath_V
execute positioned ^-1 ^ ^-100 run tag @e[limit=1,sort=nearest,tag=!swPool_fake,tag=swPool_pool,tag=!swPool_cue,tag=!swPool_rack_assigned,type=armor_stand] add swPool_rack_assigned

execute positioned ^-1 ^ ^-100 run scoreboard players operation @e[limit=1,sort=nearest,tag=!swPool_fake,tag=swPool_pool,tag=!swPool_cue,tag=!swPool_rack_assigned,type=armor_stand] swPool_vx = #12voH swMath_V
execute positioned ^-1 ^ ^-100 run scoreboard players operation @e[limit=1,sort=nearest,tag=!swPool_fake,tag=swPool_pool,tag=!swPool_cue,tag=!swPool_rack_assigned,type=armor_stand] swPool_vz = #12voV swMath_V
execute positioned ^-1 ^ ^-100 run tag @e[limit=1,sort=nearest,tag=!swPool_fake,tag=swPool_pool,tag=!swPool_cue,tag=!swPool_rack_assigned,type=armor_stand] add swPool_rack_assigned

execute positioned ^-1 ^ ^-100 run scoreboard players operation @e[limit=1,sort=nearest,tag=!swPool_fake,tag=swPool_pool,tag=!swPool_cue,tag=!swPool_rack_assigned,type=armor_stand] swPool_vx = #13voH swMath_V
execute positioned ^-1 ^ ^-100 run scoreboard players operation @e[limit=1,sort=nearest,tag=!swPool_fake,tag=swPool_pool,tag=!swPool_cue,tag=!swPool_rack_assigned,type=armor_stand] swPool_vz = #13voV swMath_V
execute positioned ^-1 ^ ^-100 run tag @e[limit=1,sort=nearest,tag=!swPool_fake,tag=swPool_pool,tag=!swPool_cue,tag=!swPool_rack_assigned,type=armor_stand] add swPool_rack_assigned

execute positioned ^-1 ^ ^-100 run scoreboard players operation @e[limit=1,sort=nearest,tag=!swPool_fake,tag=swPool_pool,tag=!swPool_cue,tag=!swPool_rack_assigned,type=armor_stand] swPool_vx = #14voH swMath_V
execute positioned ^-1 ^ ^-100 run scoreboard players operation @e[limit=1,sort=nearest,tag=!swPool_fake,tag=swPool_pool,tag=!swPool_cue,tag=!swPool_rack_assigned,type=armor_stand] swPool_vz = #14voV swMath_V
execute positioned ^-1 ^ ^-100 run tag @e[limit=1,sort=nearest,tag=!swPool_fake,tag=swPool_pool,tag=!swPool_cue,tag=!swPool_rack_assigned,type=armor_stand] add swPool_rack_assigned

execute positioned ^-1 ^ ^-100 run scoreboard players operation @e[limit=1,sort=nearest,tag=!swPool_fake,tag=swPool_pool,tag=!swPool_cue,tag=!swPool_rack_assigned,type=armor_stand] swPool_vx = #15voH swMath_V
execute positioned ^-1 ^ ^-100 run scoreboard players operation @e[limit=1,sort=nearest,tag=!swPool_fake,tag=swPool_pool,tag=!swPool_cue,tag=!swPool_rack_assigned,type=armor_stand] swPool_vz = #15voV swMath_V
execute positioned ^-1 ^ ^-100 run tag @e[limit=1,sort=nearest,tag=!swPool_fake,tag=swPool_pool,tag=!swPool_cue,tag=!swPool_rack_assigned,type=armor_stand] add swPool_rack_assigned
