...
execute at @a[tag=swPool_poolplay,nbt={SelectedItem:{id:"minecraft:bow",tag:{swPool_cuestick:1b}}}] as @e[type=arrow,distance=..5] store result score @s swPool_player run data get entity @s Owner[1]
...
execute unless score #headstring swPool_var00 matches 1 if data storage minecraft:swpool cueballreddot if entity @e[type=armor_stand,tag=swPool_pooltable,tag=swPool_cn8ballmode] as @a[tag=swPool_ballinhand] at @s[nbt={SelectedItem:{tag:{CustomModelData:99},id:"minecraft:carrot_on_a_stick"}}] run function pool:classes/ballinhand/practice/main
execute if score #headstring swPool_var00 matches 1 if data storage minecraft:swpool cueballreddot if entity @e[type=armor_stand,tag=swPool_pooltable,tag=swPool_cn8ballmode] as @a[tag=swPool_ballinhand] at @s[nbt={SelectedItem:{tag:{CustomModelData:99},id:"minecraft:carrot_on_a_stick"}}] run function pool:classes/ballinhand/uk8ball/main
execute unless score #headstring swPool_var00 matches 1 unless data storage minecraft:swpool cueballreddot if entity @e[type=armor_stand,tag=swPool_pooltable,tag=swPool_cn8ballmode] as @a[tag=swPool_ballinhand] at @s[nbt={SelectedItem:{tag:{CustomModelData:100},id:"minecraft:carrot_on_a_stick"}}] run function pool:classes/ballinhand/practice/main
...
execute unless score #headstring swPool_var00 matches 1 if data storage minecraft:swpool cueballreddot if entity @e[type=armor_stand,tag=swPool_pooltable,tag=swPool_9ballmode] as @a[tag=swPool_ballinhand] at @s[nbt={SelectedItem:{tag:{CustomModelData:99},id:"minecraft:carrot_on_a_stick"}}] run function pool:classes/ballinhand/practice/main
execute if score #headstring swPool_var00 matches 1 if data storage minecraft:swpool cueballreddot if entity @e[type=armor_stand,tag=swPool_pooltable,tag=swPool_9ballmode] as @a[tag=swPool_ballinhand] at @s[nbt={SelectedItem:{tag:{CustomModelData:99},id:"minecraft:carrot_on_a_stick"}}] run function pool:classes/ballinhand/uk8ball/main
execute unless score #headstring swPool_var00 matches 1 unless data storage minecraft:swpool cueballreddot if entity @e[type=armor_stand,tag=swPool_pooltable,tag=swPool_9ballmode] as @a[tag=swPool_ballinhand] at @s[nbt={SelectedItem:{tag:{CustomModelData:100},id:"minecraft:carrot_on_a_stick"}}] run function pool:classes/ballinhand/practice/main
execute if score #headstring swPool_var00 matches 1 unless data storage minecraft:swpool cueballreddot if entity @e[type=armor_stand,tag=swPool_pooltable,tag=swPool_9ballmode] as @a[tag=swPool_ballinhand] at @s[nbt={SelectedItem:{tag:{CustomModelData:100},id:"minecraft:carrot_on_a_stick"}}] run function pool:classes/ballinhand/uk8ball/main

execute if data storage minecraft:swpool cueballreddot if entity @e[type=armor_stand,tag=swPool_pooltable,tag=swPool_snookermode] as @a[tag=swPool_ballinhand] at @s[nbt={SelectedItem:{tag:{CustomModelData:99},id:"minecraft:carrot_on_a_stick"}}] run function pool:classes/ballinhand/snooker/main
execute if data storage minecraft:swpool cueballreddot if entity @e[type=armor_stand,tag=swPool_pooltable,tag=swPool_uk8ballmode] as @a[tag=swPool_ballinhand] at @s[nbt={SelectedItem:{tag:{CustomModelData:99},id:"minecraft:carrot_on_a_stick"}}] run function pool:classes/ballinhand/uk8ball/main
execute if data storage minecraft:swpool cueballreddot if entity @e[type=armor_stand,tag=swPool_pooltable,tag=swPool_practicemode] as @a[tag=swPool_ballinhand] at @s[nbt={SelectedItem:{tag:{CustomModelData:99},id:"minecraft:carrot_on_a_stick"}}] run function pool:classes/ballinhand/practice/main
execute unless data storage minecraft:swpool cueballreddot if entity @e[type=armor_stand,tag=swPool_pooltable,tag=swPool_snookermode] as @a[tag=swPool_ballinhand] at @s[nbt={SelectedItem:{tag:{CustomModelData:100},id:"minecraft:carrot_on_a_stick"}}] run function pool:classes/ballinhand/snooker/main
execute unless data storage minecraft:swpool cueballreddot if entity @e[type=armor_stand,tag=swPool_pooltable,tag=swPool_uk8ballmode] as @a[tag=swPool_ballinhand] at @s[nbt={SelectedItem:{tag:{CustomModelData:100},id:"minecraft:carrot_on_a_stick"}}] run function pool:classes/ballinhand/uk8ball/main
execute unless data storage minecraft:swpool cueballreddot if entity @e[type=armor_stand,tag=swPool_pooltable,tag=swPool_practicemode] as @a[tag=swPool_ballinhand] at @s[nbt={SelectedItem:{tag:{CustomModelData:100},id:"minecraft:carrot_on_a_stick"}}] run function pool:classes/ballinhand/practice/main
...
execute if entity @e[type=armor_stand,tag=swPool_pooltable,tag=swPool_snookermode] as @a[tag=swPool_ballinhand_obj] at @s[nbt={SelectedItem:{tag:{swPool_obj:1b},id:"minecraft:carrot_on_a_stick"}}] run function pool:classes/ballinhand/practice/main_obj
