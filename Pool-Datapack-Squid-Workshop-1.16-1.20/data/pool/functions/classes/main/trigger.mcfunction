...
execute if score @s swPool__trigger matches 1133021 run function app:settings/pool/bot/action_space_10
execute if score @s swPool__trigger matches 1133022 run function app:settings/pool/bot/action_space_5
execute if score @s swPool__trigger matches 1133024 run function app:settings/pool/bot/n_aims_eval
execute if score @s swPool__trigger matches 1133025 run function app:settings/pool/bot/tick_per_eval
...
execute if score @s swPool__trigger matches 1133101 run function app:settings/pool/restitution/impact
execute if score @s swPool__trigger matches 1133111 run function app:settings/pool/rules/automatic_judge_off
execute if score @s swPool__trigger matches 1133112 run function app:settings/pool/rules/automatic_judge_on
execute if score @s swPool__trigger matches 1133113 run function app:settings/pool/rules/foul_reason_feedback
execute if score @s swPool__trigger matches 1133114 run function app:settings/pool/rules/foul_reason_hide
execute if score @s swPool__trigger matches 1133115 run function app:settings/pool/rules/rail_rule_enforce
execute if score @s swPool__trigger matches 1133116 run function app:settings/pool/rules/rail_rule_ignore
execute if score @s swPool__trigger matches 1133117 run function app:settings/pool/rules/singleplayer_role_keep
execute if score @s swPool__trigger matches 1133118 run function app:settings/pool/rules/singleplayer_role_switch
execute if score @s swPool__trigger matches 1133131 run function app:settings/pool/version/1_16
execute if score @s swPool__trigger matches 1133132 run function app:settings/pool/version/1_17
execute if score @s swPool__trigger matches 1133133 run function app:settings/pool/version/1_18
execute if score @s swPool__trigger matches 1133134 run function app:settings/pool/version/1_19
execute if score @s swPool__trigger matches 1133135 run function app:settings/pool/version/1_20_4_andminus
execute if score @s swPool__trigger matches 1133136 run function app:settings/pool/version/1_20_5_andplus
execute if score @s swPool__trigger matches 1133137 run function app:settings/pool/version/reset
execute if score @s swPool__trigger matches 1133141 run function app:settings/pool/visuals/cueball_clean
execute if score @s swPool__trigger matches 1133142 run function app:settings/pool/visuals/cueball_red_dots
execute if score @s swPool__trigger matches 1133143 run function app:settings/pool/visuals/disable_ball_spinning
execute if score @s swPool__trigger matches 1133144 run function app:settings/pool/visuals/enable_ball_spinning
execute if score @s swPool__trigger matches 1133145 run function app:settings/pool/visuals/tp_duration
...
execute if score @s swPool__trigger matches 11331211 run function app:settings/pool/snooker/display/dialogue
execute if score @s swPool__trigger matches 11331212 run function app:settings/pool/snooker/display/sidebar
