...
execute if score @s swPool__trigger matches 11116 run function app:get/pool/cuestick_helper
execute if score @s swPool__trigger matches 11212 run function app:help/pool/rulewindow
execute if score @s swPool__trigger matches 112131 run function app:help/pool/about/games
execute if score @s swPool__trigger matches 112132 run function app:help/pool/about/rules
execute if score @s swPool__trigger matches 112151 run function app:help/pool/notes/release_note
execute if score @s swPool__trigger matches 112161 run function app:help/pool/settings/_help
execute if score @s swPool__trigger matches 112162 run function app:help/pool/settings/_help_version
...
execute if score @s swPool__trigger matches 1133071 run function app:settings/pool/reload/cleanongoingsession
execute if score @s swPool__trigger matches 1133072 run function app:settings/pool/reload/keepongoingsession
execute if score @s swPool__trigger matches 1133081 run function app:settings/pool/rules/automatic_judge_off
execute if score @s swPool__trigger matches 1133082 run function app:settings/pool/rules/automatic_judge_on
execute if score @s swPool__trigger matches 1133083 run function app:settings/pool/rules/foul_reason_feedback
execute if score @s swPool__trigger matches 1133084 run function app:settings/pool/rules/foul_reason_hide
execute if score @s swPool__trigger matches 1133085 run function app:settings/pool/rules/rail_rule_enforce
execute if score @s swPool__trigger matches 1133086 run function app:settings/pool/rules/rail_rule_ignore
execute if score @s swPool__trigger matches 1133087 run function app:settings/pool/rules/singleplayer_role_keep
execute if score @s swPool__trigger matches 1133088 run function app:settings/pool/rules/singleplayer_role_switch
execute if score @s swPool__trigger matches 1133101 run function app:settings/pool/version/1_16
execute if score @s swPool__trigger matches 1133102 run function app:settings/pool/version/1_17
execute if score @s swPool__trigger matches 1133103 run function app:settings/pool/version/1_18
execute if score @s swPool__trigger matches 1133104 run function app:settings/pool/version/1_19
execute if score @s swPool__trigger matches 1133105 run function app:settings/pool/version/1_20_4_andminus
execute if score @s swPool__trigger matches 1133106 run function app:settings/pool/version/1_20_5_andplus
execute if score @s swPool__trigger matches 1133107 run function app:settings/pool/version/reset
execute if score @s swPool__trigger matches 1133111 run function app:settings/pool/visuals/cueball_clean
execute if score @s swPool__trigger matches 1133112 run function app:settings/pool/visuals/cueball_red_dots
execute if score @s swPool__trigger matches 1133113 run function app:settings/pool/visuals/disable_ball_spinning
execute if score @s swPool__trigger matches 1133114 run function app:settings/pool/visuals/enable_ball_spinning
execute if score @s swPool__trigger matches 1133115 run function app:settings/pool/visuals/tp_duration
...
execute if score @s swPool__trigger matches 11330911 run function app:settings/pool/snooker/display/dialogue
execute if score @s swPool__trigger matches 11330912 run function app:settings/pool/snooker/display/sidebar
