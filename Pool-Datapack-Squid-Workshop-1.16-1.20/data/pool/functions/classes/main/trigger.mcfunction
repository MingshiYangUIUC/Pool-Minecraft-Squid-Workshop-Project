...
execute if score @s swPool__trigger matches 4112212 run function pool:classes/table/set_preview
execute if score @s swPool__trigger matches 4112213 run function pool:classes/table/start
