...
execute if entity @e[type=armor_stand,tag=swPool_col,tag=swPool_fake] run scoreboard players set #breakhappen swMath_V 0
...
execute unless score #breakhappen swMath_V matches 0 unless entity @e[type=armor_stand,tag=swPool_9ballmode] unless entity @s[tag=swPool_bounce] if entity @s[tag=swPool_col] as @e[type=armor_stand,tag=swPool_pool,tag=swPool_cue,limit=1] at @s run function pool:classes/break_nn_8ball/io
execute unless score #breakhappen swMath_V matches 0 if entity @e[type=armor_stand,tag=swPool_9ballmode] unless entity @s[tag=swPool_bounce] if entity @s[tag=swPool_col] as @e[type=armor_stand,tag=swPool_pool,tag=swPool_cue,limit=1] at @s run function pool:classes/break_nn_9ball/io
