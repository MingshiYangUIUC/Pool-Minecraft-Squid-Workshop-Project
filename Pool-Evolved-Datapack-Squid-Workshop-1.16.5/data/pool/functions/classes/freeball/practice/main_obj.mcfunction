...
execute as @e[type=area_effect_cloud,tag=swPool_cueplace] at @s run function pool:classes/freeball/practice/tp_obj
...
execute if entity @s[scores={swPool_crtclk=1..},nbt={SelectedItem:{tag:{CustomModelData:103},id:"minecraft:carrot_on_a_stick"}}] at @e[type=area_effect_cloud,tag=swPool_cueplace,tag=swPool_valid] run summon armor_stand ~ ~ ~ {Tags:["swPool_pool","swPool_free","swPool_green"],NoGravity:1,Small:1,Invisible:1}
execute if entity @s[scores={swPool_crtclk=1..},nbt={SelectedItem:{tag:{CustomModelData:104},id:"minecraft:carrot_on_a_stick"}}] at @e[type=area_effect_cloud,tag=swPool_cueplace,tag=swPool_valid] run summon armor_stand ~ ~ ~ {Tags:["swPool_pool","swPool_free","swPool_brown"],NoGravity:1,Small:1,Invisible:1}
execute if entity @s[scores={swPool_crtclk=1..},nbt={SelectedItem:{tag:{CustomModelData:105},id:"minecraft:carrot_on_a_stick"}}] at @e[type=area_effect_cloud,tag=swPool_cueplace,tag=swPool_valid] run summon armor_stand ~ ~ ~ {Tags:["swPool_pool","swPool_free","swPool_blue"],NoGravity:1,Small:1,Invisible:1}
execute if entity @s[scores={swPool_crtclk=1..},nbt={SelectedItem:{tag:{CustomModelData:106},id:"minecraft:carrot_on_a_stick"}}] at @e[type=area_effect_cloud,tag=swPool_cueplace,tag=swPool_valid] run summon armor_stand ~ ~ ~ {Tags:["swPool_pool","swPool_free","swPool_pink"],NoGravity:1,Small:1,Invisible:1}
execute if entity @s[scores={swPool_crtclk=1..},nbt={SelectedItem:{tag:{CustomModelData:107},id:"minecraft:carrot_on_a_stick"}}] at @e[type=area_effect_cloud,tag=swPool_cueplace,tag=swPool_valid] run summon armor_stand ~ ~ ~ {Tags:["swPool_pool","swPool_free","swPool_black"],NoGravity:1,Small:1,Invisible:1}
...
#execute if entity @e[tag=swPool_pool,tag=swPool_free] run clear @a[tag=swPool_freeball_obj] carrot_on_a_stick{CustomModelData:99} 1
