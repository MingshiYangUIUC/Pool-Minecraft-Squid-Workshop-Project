...
execute as @e[type=area_effect_cloud,tag=swPool_thp1,limit=1] store result score @s swPool_var01 run data get entity @s Pos[0] 10000
execute as @e[type=area_effect_cloud,tag=swPool_thp2,limit=1] store result score @s swPool_var02 run data get entity @s Pos[0] 10000
