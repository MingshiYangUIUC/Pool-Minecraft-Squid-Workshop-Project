...
tellraw @s [{"text":"║ ","color":"white"},{"underlined":true,"text":"<(Re)start Practice Mode>","color":"gold","clickEvent":{"action":"run_command","value":"/function pool:classes/practice/start"}},{"text":" ","underlined":false},{"underlined":true,"text":"<Practice Mode Now>","color":"yellow","clickEvent":{"action":"run_command","value":"/function pool:classes/practice/switch"}}]
...
tellraw @s [{"text":"║ ","color":"white"},{"underlined":true,"text":"<Settings>","color":"white","clickEvent":{"action":"suggest_command","value":"/function app:settings/pool/"}},{"text":"","color":"white"}]
tellraw @s [{"text":"╚════════════════════════════════╝"}]
