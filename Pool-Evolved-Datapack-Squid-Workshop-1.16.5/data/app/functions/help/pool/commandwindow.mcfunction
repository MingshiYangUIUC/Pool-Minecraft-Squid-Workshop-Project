...
tellraw @s [{"text":"║ ","color":"white"},{"underlined":true,"text":"<(Re)start Practice Mode>","color":"gold","clickEvent":{"action":"run_command","value":"/function pool:classes/practice/start"}}]
