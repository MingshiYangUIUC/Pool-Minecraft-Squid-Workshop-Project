...
execute if entity @e[tag=swPool_pooltable,limit=1,tag=swPool_snookermode] if entity @s[scores={swPool_crtclk=1..},nbt={SelectedItem:{tag:{CustomModelData:102},id:"minecraft:carrot_on_a_stick"}}] run clear @s carrot_on_a_stick{CustomModelData:102}
execute if entity @e[tag=swPool_pooltable,limit=1,tag=swPool_snookermode] if entity @s[scores={swPool_crtclk=1..},nbt={SelectedItem:{tag:{CustomModelData:103},id:"minecraft:carrot_on_a_stick"}}] run clear @s carrot_on_a_stick{CustomModelData:103}
execute if entity @e[tag=swPool_pooltable,limit=1,tag=swPool_snookermode] if entity @s[scores={swPool_crtclk=1..},nbt={SelectedItem:{tag:{CustomModelData:104},id:"minecraft:carrot_on_a_stick"}}] run clear @s carrot_on_a_stick{CustomModelData:104}
execute if entity @e[tag=swPool_pooltable,limit=1,tag=swPool_snookermode] if entity @s[scores={swPool_crtclk=1..},nbt={SelectedItem:{tag:{CustomModelData:105},id:"minecraft:carrot_on_a_stick"}}] run clear @s carrot_on_a_stick{CustomModelData:105}
execute if entity @e[tag=swPool_pooltable,limit=1,tag=swPool_snookermode] if entity @s[scores={swPool_crtclk=1..},nbt={SelectedItem:{tag:{CustomModelData:106},id:"minecraft:carrot_on_a_stick"}}] run clear @s carrot_on_a_stick{CustomModelData:106}
execute if entity @e[tag=swPool_pooltable,limit=1,tag=swPool_snookermode] if entity @s[scores={swPool_crtclk=1..},nbt={SelectedItem:{tag:{CustomModelData:107},id:"minecraft:carrot_on_a_stick"}}] run clear @s carrot_on_a_stick{CustomModelData:107}
