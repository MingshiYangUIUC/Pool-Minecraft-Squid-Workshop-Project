...
execute unless entity @e[type=armor_stand,tag=swPool_pool,tag=swPool_09,limit=1] if entity @e[tag=swPool_hitcue,tag=!swPool_foul] run tag @s add swPool_endgame 
...
execute unless entity @e[type=armor_stand,tag=swPool_pool,tag=swPool_09,limit=1] if entity @e[tag=swPool_hitcue,tag=swPool_foul] at @s run function pool:classes/master/9ball/respot_9
