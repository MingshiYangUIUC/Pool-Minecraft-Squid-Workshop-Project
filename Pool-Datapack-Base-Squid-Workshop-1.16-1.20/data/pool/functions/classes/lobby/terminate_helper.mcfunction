...
execute if entity 000c2be1-0001-414d-0000-000000000000 unless entity @e[type=armor_stand,tag=swPool_pooltable,distance=..50] run tellraw @s[tag=swPool_EN] [{"text":"➇ ","color":"white"},{"text":"Please be near the table to turn off the game.","color":"red"}]
execute if entity 000c2be1-0001-414d-0000-000000000000 unless entity @e[type=armor_stand,tag=swPool_pooltable,distance=..50] run tellraw @s[tag=swPool_CN] [{"text":"➇ ","color":"white"},{"text":"请在球桌边结束游戏。","color":"red"}]
