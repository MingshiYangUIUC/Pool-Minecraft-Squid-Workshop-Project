...
tellraw @s[tag=swPool_EN,gamemode=!creative] [{"text":"➇ ","color":"white"},{"text":""},{"underlined":true,"text":"<Non-Creative Notice>","color":"red","clickEvent":{"action":"run_command","value":"/function app:help/pool/noncreativewindow"}}]
tellraw @s[tag=swPool_CN,gamemode=!creative] [{"text":"➇ ","color":"white"},{"text":""},{"underlined":true,"text":"<非创造模式须知>","color":"red","clickEvent":{"action":"run_command","value":"/function app:help/pool/noncreativewindow"}}]
