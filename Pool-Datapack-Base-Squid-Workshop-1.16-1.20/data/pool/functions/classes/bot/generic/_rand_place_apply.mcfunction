...
tellraw @a [{"text":"nt, "},{"score":{"objective":"swMath_V","name":"#nt"}}]
tellraw @a [{"text":"cdx, "},{"score":{"objective":"swMath_V","name":"#cdx"}}]
tellraw @a [{"text":"cdz, "},{"score":{"objective":"swMath_V","name":"#cdz"}}]
