...
execute unless score #fastfwd_bot swMath_V matches 1 if score #tick swPool_var00 matches 0 at 000c2be1-0001-414d-0000-000000000000 if entity @e[type=armor_stand,tag=swPool_pool,scores={swPool_v=1..},distance=..20] run function pool:classes/main/tick_iterate
