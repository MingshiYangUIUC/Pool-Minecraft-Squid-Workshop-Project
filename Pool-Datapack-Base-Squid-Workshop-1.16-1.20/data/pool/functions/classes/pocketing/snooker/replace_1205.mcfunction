...
execute if data storage minecraft:swpool cueballreddot run item replace entity @e[tag=swPool_pool,tag=swPool_new,tag=swPool_cue] armor.head with minecraft:acacia_button[minecraft:custom_model_data=1]
execute unless data storage minecraft:swpool cueballreddot run item replace entity @e[tag=swPool_pool,tag=swPool_new,tag=swPool_cue] armor.head with minecraft:acacia_button[minecraft:custom_model_data=36]
item replace entity @e[tag=swPool_pool,tag=swPool_new,tag=swPool_red] armor.head with minecraft:acacia_button[minecraft:custom_model_data=2]
item replace entity @e[tag=swPool_pool,tag=swPool_new,tag=swPool_yellow] armor.head with minecraft:acacia_button[minecraft:custom_model_data=3]
item replace entity @e[tag=swPool_pool,tag=swPool_new,tag=swPool_green] armor.head with minecraft:acacia_button[minecraft:custom_model_data=4]
item replace entity @e[tag=swPool_pool,tag=swPool_new,tag=swPool_brown] armor.head with minecraft:acacia_button[minecraft:custom_model_data=5]
item replace entity @e[tag=swPool_pool,tag=swPool_new,tag=swPool_blue] armor.head with minecraft:acacia_button[minecraft:custom_model_data=6]
item replace entity @e[tag=swPool_pool,tag=swPool_new,tag=swPool_pink] armor.head with minecraft:acacia_button[minecraft:custom_model_data=7]
item replace entity @e[tag=swPool_pool,tag=swPool_new,tag=swPool_black] armor.head with minecraft:acacia_button[minecraft:custom_model_data=8]

execute if data storage minecraft:swpool {allowspin:1} as @e[tag=swPool_pool,tag=swPool_new] at @s run function pool:classes/pose/randomize_pose
